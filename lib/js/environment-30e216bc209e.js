(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["environment"], {
		30523: e => {
			e.exports = {
				polyfill: function() {
					...
					if (!("scrollBehavior" in o.documentElement.style) || !0 === t.__forceSmoothScrollPolyfill__) {
						...
						t.scroll = t.scrollTo = function() {
							if (void 0 !== arguments[0]) {
								if (!0 === s(arguments[0])) {
									n.scroll.call(t, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : t.scrollX || t.pageXOffset, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : t.scrollY || t.pageYOffset);
									return
								}
							...
							if (void 0 !== arguments[0]) {
								if (s(arguments[0])) {
									n.scrollBy.call(t, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : 0, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : 0);
									return
								}
							...
							var e = function(e) {
									for (var t, r, n; e !== o.body && !1 === (r = c(t = e, "Y") && u(t, "Y"), n = c(t, "X") && u(t, "X"), r || n);) e = e.parentNode || e.host;
									return e
								}(this),
								r = e.getBoundingClientRect(),
								l = this.getBoundingClientRect();
							e !== o.body ? (f.call(this, e, e.scrollLeft + l.left - r.left, e.scrollTop + l.top - r.top), "fixed" !== t.getComputedStyle(e).position && t.scrollBy({
								left: r.left,
								top: r.top,
								behavior: "smooth"
							})) : t.scrollBy({
					...
					function f(e, r, i) {
						var s, c, u, f, d = l();
						e === o.body ? (s = t, c = t.scrollX || t.pageXOffset, u = t.scrollY || t.pageYOffset, f = n.scroll) : (s = e, c = e.scrollLeft, u = e.scrollTop, f = a),
							function e(o) {
								var r, n, i, a = (l() - o.startTime) / 468;
								r = .5 * (1 - Math.cos(Math.PI * (a = a > 1 ? 1 : a))), n = o.startX + (o.x - o.startX) * r, i = o.startY + (o.y - o.startY) * r, o.method.call(o.scrollable, n, i), (n !== o.x || i !== o.y) && t.requestAnimationFrame(e.bind(t, o))
							}({
								scrollable: s,
								method: f,
								startTime: d,
		...
		42281: (e, t, o) => {
			...
			var r = o(24601),
				n = o(86283);
			n.iG?.addEventListener("error", e => {
				e.error && r.eK(e.error)
			}), n.iG?.addEventListener("unhandledrejection", async e => {
				if (e.promise) try {
					await e.promise
				} catch (e) {
					r.eK(e)
				}
			}), n.iG?.location.hash === "#b00m" && setTimeout(() => {
				throw Error("b00m")
			}), o(30523), o(13604);
			var l = o(22490),
				i = o(7180);
		...
		24601: (e, t, o) => {
			...
			let f = !1,
				d = 0,
				p = Date.now(),
				y = new Set(["Failed to fetch", "NetworkError when attempting to fetch resource."]);

			function m(e) {
				return !!("AbortError" === e.name || "TypeError" === e.name && y.has(e.message) || e.name.startsWith("ApiError") && y.has(e.message))
			}
			...
			async function v(e) {
				if (!(!S && !f && d < 10 && (0, n.Gb)())) return;
				let t = document.head?.querySelector('meta[name="browser-errors-url"]')?.content;
				if (t) {
					if (e.error.stacktrace.some(e => T.test(e.filename) || T.test(e.function))) {
						f = !0;
						return
					}
					d++;
			...
			let T = /(chrome|moz|safari)-extension:\/\//;
			...
			let S = !1;
			if (c.iG?.addEventListener("pageshow", () => S = !1), c.iG?.addEventListener("pagehide", () => S = !0), "function" == typeof BroadcastChannel) {
				let e = new BroadcastChannel("shared-worker-error");
				e.addEventListener("message", e => {
					h(e.data.error)
				})
			}
			let E = ["Object Not Found Matching Id", "Not implemented on this platform", "provider because it's not your default extension"]
		},
		95253: (e, t, o) => {
			"use strict";
			let r;
			...
			let {
				getItem: s
			} = (0, i.Z)("localStorage"), c = "dimension_", u = ["utm_source", "utm_medium", "utm_campaign", "utm_term", "utm_content", "scid"];
			try {
				let e = (0, n.n)("octolytics");
				delete e.baseContext, r = new l.R(e)
			} catch (e) {}
			...
			function f(e) {
				...
				for (let [e, o] of r) u.includes(e.toLowerCase()) && (t[e] = o);
					...
					try {
						...
						return c && new Promise(e => {
							...
							if (l.length !== r.length) {
								let i = Error("Trusted Types policy output sanitized"),
									a = i.stack?.slice(0, 1e3),
									c = l.slice(0, 250);
								(0, s.qP)("trusted_types_policy.sanitize", {
									policyName: t,
									output: c,
									stack: a,
									outputLength: l.length,
						...
						if (e instanceof TrustedTypesPolicyError || (u || (0, l.eK)(e), (0, n.b)({
	...
	e => {
		var t = t => e(e.s = t);
		e.O(0, ["vendors-node_modules_dompurify_dist_purify_js", "vendors-node_modules_stacktrace-parser_dist_stack-trace-parser_esm_js-node_modules_github_bro-a4c183", "vendors-node_modules_github_hydro-analytics-client_dist_analytics-client_js-node_modules_gith-6a10dd", "ui_packages_soft-nav_soft-nav_ts"], () => t(42281)), e.O()
	}
]);
//# sourceMappingURL=environment-1a9619e98436.js.map