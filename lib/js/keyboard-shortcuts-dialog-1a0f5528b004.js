...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["keyboard-shortcuts-dialog"], {
		...
		4412: (e, t, n) => {
			...
			var r = n(86283);
			let a = r.n4?.readyState === "interactive" || r.n4?.readyState === "complete" ? Promise.resolve() : new Promise(e => {
					r.n4?.addEventListener("DOMContentLoaded", () => {
						e()
					})
				}),
				o = r.n4?.readyState === "complete" ? Promise.resolve() : new Promise(e => {
				...
				return function() {
					...
					if (r.iG) {
						let n = r.iG.navigator,
							o = n.userAgent,
							i = n?.userAgentData?.platform || n.platform; - 1 !== ["Macintosh", "MacIntel", "MacPPC", "Mac68K", "macOS"].indexOf(i) ? e = a.macOS : -1 !== ["iPhone", "iPad", "iPod"].indexOf(i) ? e = a.iOS : -1 !== ["Win32", "Win64", "Windows", "WinCE"].indexOf(i) ? e = a.Windows : /Android/.test(o) ? e = a.Android : /Linux/.test(i) && (e = a.Linux), t = n?.userAgentData?.mobile ?? (e === a.Android || e === a.iOS)
					}
					return {
						os: e,
					...
					let t = (0, a.EL)(e),
						n = function(e) {
							...
							let t = e.nodeName.toLowerCase(),
								...
								r = "true" === e.ariaReadOnly || "true" === e.getAttribute("aria-readonly") || null !== e.getAttribute("readonly");
							return ("select" === t || "textarea" === t || "input" === t && !s.has(n) || e.isContentEditable) && !r
						}(e.target) && (0, r.c)("no_character_key_shortcuts_in_inputs"),
						l = o() && !n;
					return i(t) || l
				}
		},
		3886: (e, t, n) => {
			var r, a, o = n(9067),
				...
				l = n(67044),
				d = n(46426);
			let c = JSON.parse('{"services":{"global":{"id":"global","name":"Global","commandIds":["global:submit-form","global:open-context-menu"]},"keyboard-shortcuts-dialog":{"id":"keyboard-shortcuts-dialog","name":"Keyboard Shortcuts Dialog","commandIds":["keyboard-shortcuts-dialog:show-dialog"]},"react-sandbox":{"id":"react-sandbox","name":"React Sandbox","commandIds":["react-sandbox:example-command"]}},"commands":{"global:open-context-menu":{"name":"Open context menu","description":"Open a context menu if one is available","defaultBinding":"Alt+Shift+C"},"global:submit-form":{"name":"Submit form","description":"Submit the current form","defaultBinding":"Mod+Enter"},"keyboard-shortcuts-dialog:show-dialog":{"name":"Show Keyboard Shortcuts Dialog","description":"Display the keyboard shortcuts help dialog","defaultBinding":"Shift+?"},"react-sandbox:example-command":{"name":"React Sandbox Example Command","description":"Do something.","defaultBinding":"Mod+Shift+Enter"}}}'),
				{
					commands: u,
					services: m
				} = c,
			...
			let x = {
				entries: e => Object.entries(e).filter(e => h.is(e[0]) && void 0 !== e[1]),
				keys: e => Object.keys(e).filter(h.is)
			};
			var S = n(86058);
			let k = new S.R({
				...
				E.send({
					...
					target_element_html: t.target instanceof HTMLElement ? function(e) {
						let t = e.tagName.toLowerCase(),
							n = Array.from(e.attributes).map(e => `${e.name}="${e.value.replaceAll('"','\\"')}"`).join(" ");
						return `<${t}${n?` ${n}`:""}>`
					}(t.target) : void 0,
			...
			function C(e, t) {
				let n = (0, s.useMemo)(() => new Map, []),
					r = "global" === e ? j : n;
				(0, s.useEffect)(() => {
					for (let [e, n] of b(x.keys(t))) {
						let t = r.get(n) ?? [];
						t.length && console.warn(`The keybinding (${n}) for the "${e}" command conflicts with the keybinding for the already-registered command(s) "${t.join(", ")}". This may result in unpredictable behavior.`), r.set(n, t.concat(e))
					}
					return () => {
						for (let [e, n] of b(x.keys(t))) {
							let t = function(e, t) {
								let n = !1;
								return e.filter(e => e !== t || !!n || (n = !0, !1))
							}(r.get(n) ?? [], e);
							t?.length ? r.set(n, t) : r.delete(n)
						}
					}
				}, [t, r])
			}
			...
			function N(e, t) {
				...
				return (0, s.useCallback)(e => {
					...
					if (a.current = o, !(0, A.Zf)(o)) {
						n.reset();
						return
					}
					n.registerKeypress(o);
					let i = r.get(n.sequence) ?? r.get((0, l.EL)(o));
					i && (n.reset(), e.preventDefault(), e.stopPropagation(), t(i, o))
				}, [r, n, t])
			}
			let L = new Map,
				I = e => {
					let t = (0, s.useId)();
					(0, s.useEffect)(() => (L.set(t, x.keys(e)), () => {
						L.delete(t)
					}), [e, t])
				},
				...
				R = ({
					...
					let t = (0, s.useCallback)((t, n) => {
						...
						n = N(x.keys(e), t);
					return C("global", e), I(e), (0, s.useEffect)(() => {
						let e = e => {
							let n = "detail" in e && "object" == typeof e.detail ? e.detail : void 0;
							if (!n) return;
							let r = "commandId" in n && "string" == typeof n.commandId && h.is(n.commandId) ? n.commandId : void 0,
								a = "domEvent" in n && (n.domEvent instanceof KeyboardEvent || n.domEvent instanceof MouseEvent) ? n.domEvent : void 0;
							r && a && t(r, a)
						};
						return document.addEventListener("keydown", n), document.addEventListener(O, e), () => {
							document.removeEventListener("keydown", n), document.removeEventListener(O, e)
						}
					}, [n, t]), null
				};
			try {
				R.displayName || (R.displayName = "GlobalCommands")
			} catch {}
			...
			try {
				(r = ({
					...
					let r = P(),
						a = (0, s.useCallback)((e, t) => {
							let a = n.current[e];
							if (a) {
								let n = new CommandEvent(e);
								try {
									a(n)
								} finally {
									_(n, t)
								}
							} else r.triggerCommand(e, t)
						}, [r]);
					C("scoped", e), I(e);
					let o = (0, s.useMemo)(() => ({
							triggerCommand: a
				...
				}).displayName || (r.displayName = "ScopedCommands")
			} catch {}
			var M = n(88216),
				F = n(24319);
			let W = ({
			...
			let Z = (0, s.forwardRef)(({
				...
				return s ? (0, i.jsx)(M.r, {
					...a,
					onClick: t => l(e, t.nativeEvent),
					trailingVisual: n ?? r ? () => (0, i.jsxs)(i.Fragment, {
			...
			U.displayName = "CommandIconButton";
			var K = n(52516);
			let $ = (0, s.forwardRef)(({
				commandId: e,
				children: t,
				...
				return l ? (0, i.jsxs)(K.S.Item, {
					...o,
					onSelect: t => d(e, t.nativeEvent),
					ref: s,
					children: [t ?? l.name, n && (0, i.jsx)(K.S.Description, {
						children: n
					}), r && (0, i.jsx)(K.S.LeadingVisual, {
						children: r
					}), null !== a && (0, i.jsx)(K.S.TrailingVisual, {
			...
			$.displayName = "ActionList.CommandItem";
			var G = n(42483),
				V = n(74121),
				H = n(43535);
					...
					children: [(0, i.jsx)(G.Z, {
						...
						children: t.map(({
							...
							children: [(0, i.jsx)(G.Z, {
								...
								children: (Array.isArray(n) ? n : [n]).map((e, t) => (0, i.jsxs)(s.Fragment, {
									children: [t > 0 && " or ", (0, i.jsx)(F.u, {
										keys: e
									})]
								}, e))
							})]
			...
			let X = () => (0, i.jsxs)(G.Z, {
				...
				en = ({
					...
					return ((0, s.useEffect)(() => {
						let t = function() {
								let e = new Map;
								for (let t of new Set(Array.from(L.values()).flat())) {
									let n = h.getServiceId(t);
									if (!e.has(n)) {
										let t = g(n);
										e.set(n, {
											service: {
									...
									let r = f(t);
									r && r.defaultBinding && e.get(n)?.commands.push({
										id: t,
										name: r.name,
										description: r.description,
										keybinding: r.defaultBinding
									})
								}
							...
							n = async () => {
								...
								let n = {
									...
									a = `/site/keyboard_shortcuts?${new URLSearchParams(n).toString()}`,
									i = await (0, Q.v)(a, {
										method: "GET"
									});
								if (i.ok) {
									...
									r({
										...
										commands: [...n.commands, ...t.find(e => "global" === e.service.id)?.commands ?? []].map(e => ({
											...e,
											keybinding: Y(e.keybinding)
										}))
									});
									let s = [...Object.values(a), ...t].map(e => ({
										...e,
										commands: e.commands.map(e => ({
											...e,
											keybinding: Y(e.keybinding)
										}))
									}));
			...
			try {
				en.displayName || (en.displayName = "ShortcutsDialog")
			} catch {}
			...
			try {
				er.displayName || (er.displayName = "KeyboardShortcutsDialog")
				...
				return {
					getItem: function(e, t = new Date().getTime()) {
						try {
							...
							if (!n) return null;
							let r = `${e}:expiry`,
								a = Number(l.getItem(r));
							if (a && t > a) return u(e), u(r), c("SAFE_STORAGE_VALUE_EXPIRED"), null;
							return c("SAFE_STORAGE_VALUE_WITHIN_TTL"), i(n)
						} catch (e) {
							return null
						}
					},
					setItem: function(e, n, r = new Date().getTime()) {
						try {
							if (l.setItem(e, s(n)), t.ttl) {
								let n = `${e}:expiry`,
									a = r + t.ttl;
								l.setItem(n, a.toString())
							}
						} catch (e) {
		...
		35647: (e, t, n) => {
			...
			function i() {
				return !!a || !!r.n4.querySelector('react-app[data-ssr="true"]')
			}
		},
		71643: (e, t, n) => {
			n.d(t, {
			...
			function l(e, t = !1, n = 1) {
				if (!0 !== (0, i.c)("BROWSER_STATS_DISABLED")) {
					...
					void 0 === e.timestamp && (e.timestamp = new Date().getTime()), e.loggedIn = !!r.n4?.head?.querySelector('meta[name="user-login"]')?.content, e.staff = m(), e.bundler = o.A7, Math.random() < n && s.push(e), t ? u() : c()
				}
			}
			let d = null;
			async function c() {
			...
			r.n4?.addEventListener("pagehide", u), r.n4?.addEventListener("visibilitychange", u)
		},
		17521: (e, t, n) => {
			n.d(t, {
				u: () => i
			...
			let o = new Set(["enter", "tab"]),
				i = e => {
					let t = (0, a.useRef)(!1),
						n = (0, a.useRef)(!1),
						i = (0, a.useCallback)(e => {
							"compositionstart" === e.type && (t.current = !0, n.current = !1), "compositionend" === e.type && (t.current = !1, n.current = !0)
						}, []),
						s = (0, a.useCallback)(a => {
							if (!o.has(a.key.toLowerCase()) || !t.current) {
								if ((0, r.eE)() && 229 === a.keyCode && n.current) {
									n.current = !1;
									return
								}
								e(a)
		...
		24319: (e, t, n) => {
			...
			let h = ({
				...
				y = ({
					...
					children: e.split("+").map(e => e.toLowerCase()).sort(g).map((e, n) => (0, r.jsxs)(i.Fragment, {
						children: [n > 0 && "full" === t ? (0, r.jsx)("span", {
							"aria-hidden": !0,
							children: " + "
						}) : " ", (0, r.jsx)(f, {
							name: e,
				...
				b = (0, i.memo)(({
					...
					children: e.split(" ").map((e, n) => (0, r.jsxs)(i.Fragment, {
						children: [n > 0 && (0, r.jsxs)(r.Fragment, {
							children: [(0, r.jsx)(s.T, {
								children: ", then"
							}), " "]
						}), (0, r.jsx)(y, {
			...
			try {
				h.displayName || (h.displayName = "Kbd")
			} catch {}
			try {
		...
		32369: (e, t, n) => {
			...
			function c({
				...
				return (0, d.g)(() => t.listen(o), [t]), (0, r.jsx)(l.F0, {
					location: n.location,
					navigator: t,
					children: e
				})
			...
			try {
				p.displayName || (p.displayName = "PartialEntry")
			} catch {}
		},
		59841: (e, t, n) => {
			n.d(t, {
