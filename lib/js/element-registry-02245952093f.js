...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["element-registry"], {
		...
		76006: (e, s, _) => {
			...
			function a(e = document) {
				...
				let s = !1,
					_ = new MutationObserver(e => {
						for (let s of e)
							if ("attributes" === s.type && s.target instanceof Element) l(s.target);
							else if ("childList" === s.type && s.addedNodes.length)
							for (let e of s.addedNodes) e instanceof Element && d(e)
					});
				_.observe(e, {
					childList: !0,
					subtree: !0,
			...
			function d(e) {
				for (let s of e.querySelectorAll("[data-action]")) l(s);
			...
			function i(e) {
				...
				for (let _ of r(s))
					if (e.type === _.type) {
						let t = s.closest(_.tag);
						n.has(t) && "function" == typeof t[_.method] && t[_.method](e);
						let o = s.getRootNode();
						if (o instanceof ShadowRoot && n.has(o.host) && o.host.matches(_.tag)) {
							let s = o.host;
							"function" == typeof s[_.method] && s[_.method](e)
						}
					}
			}

			function* r(e) {
				for (let s of (e.getAttribute("data-action") || "").trim().split(/\s+/)) {
					let e = s.lastIndexOf(":"),
						_ = Math.max(0, s.lastIndexOf("#")) || s.length;
					yield {
						type: s.slice(0, e),
						tag: s.slice(e + 1, _),
						method: s.slice(_ + 1) || "handleEvent"
					}
				}
			}

			function l(e) {
				for (let s of r(e)) e.addEventListener(s.type, i)
			}

			function c(e, s) {
				let _ = e.tagName.toLowerCase();
				if (e.shadowRoot) {
					for (let t of e.shadowRoot.querySelectorAll(`[data-target~="${_}.${s}"]`))
						if (!t.closest(_)) return t
				}
				for (let t of e.querySelectorAll(`[data-target~="${_}.${s}"]`))
					if (t.closest(_) === e) return t
			}
			let m = e => String("symbol" == typeof e ? e.description : e).replace(/([A-Z]($|[a-z]))/g, "-$1").replace(/--/g, "-").replace(/^-|-$/, "").toLowerCase(),
				p = (e, s = "property") => {
					let _ = m(e);
					if (!_.includes("-")) throw new DOMException(`${s}: ${String(e)} is not a valid ${s} name`, "SyntaxError");
					return _
				},
				u = "attr";
			...
			function f(e, s) {
				if (b.has(e)) return;
				b.add(e);
				let _ = Object.getPrototypeOf(e),
					t = _?.constructor?.attrPrefix ?? "data-";
				for (let n of (s || (s = v(_, u)), s)) {
					let s = e[n],
						_ = p(`${t}${n}`),
						o = {
							configurable: !0,
					...
					"number" == typeof s ? o = {
						configurable: !0,
						get() {
							return Number(this.getAttribute(_) || 0)
						},
						set(e) {
							this.setAttribute(_, e)
						}
						...
						set(e) {
							this.toggleAttribute(_, e)
						}
					}), Object.defineProperty(e, n, o), n in e && !e.hasAttribute(_) && o.set.call(e, s)
				}
			}
			let g = Symbol.for("catalyst");
			let CatalystDelegate = class CatalystDelegate {
				constructor(e) {
					let s = this,
						_ = e.prototype.connectedCallback;
					e.prototype.connectedCallback = function() {
						s.connectedCallback(this, _)
					};
					let t = e.prototype.disconnectedCallback;
					e.prototype.disconnectedCallback = function() {
						s.disconnectedCallback(this, t)
					};
					let n = e.prototype.attributeChangedCallback;
					e.prototype.attributeChangedCallback = function(e, _, t) {
						s.attributeChangedCallback(this, e, _, t, n)
					};
					let o = e.observedAttributes || [];
					Object.defineProperty(e, "observedAttributes", {
							configurable: !0,
							get() {
								return s.observedAttributes(this, o)
							},
							set(e) {
								o = e
							}
						...
						function(e) {
							let s = e.observedAttributes || [],
								_ = e.attrPrefix ?? "data-",
								t = e => p(`${_}${e}`);
							Object.defineProperty(e, "observedAttributes", {
								configurable: !0,
								get: () => [...v(e.prototype, u)].map(t).concat(s),
								set(e) {
									s = e
								}
							})
						...
						function(e) {
							let s = m(e.name).replace(/-element$/, "");
							try {
								window.customElements.define(s, e), window[e.name] = customElements.get(s)
							} catch (e) {
								if (!(e instanceof DOMException && "NotSupportedError" === e.name)) throw e
							}
						}(e)
				}
				observedAttributes(e, s) {
					return s
				}
				connectedCallback(e, s) {
					var _, t;
					e.toggleAttribute("data-catalyst", !0), customElements.upgrade(e), ! function(e) {
						for (let s of e.querySelectorAll("template[data-shadowroot]")) s.parentElement === e && e.attachShadow({
							mode: "closed" === s.getAttribute("data-shadowroot") ? "closed" : "open"
						}).append(s.content.cloneNode(!0))
					}(e), f(e), n.add(e), e.shadowRoot && (d(t = e.shadowRoot), a(t)), d(e), a(e.ownerDocument), s?.call(e), e.shadowRoot && (d(_ = e.shadowRoot), a(_))
				}
				disconnectedCallback(e, s) {
					s?.call(e)
				}
				attributeChangedCallback(e, s, _, t, n) {
					f(e), "data-catalyst" !== s && n && n.call(e, s, _, t)
				}
			};
			...
			function v(e, s) {
				if (!Object.prototype.hasOwnProperty.call(e, g)) {
					let s = e[g],
						_ = e[g] = new Map;
					if (s)
						for (let [e, t] of s) _.set(e, new Set(t))
				}
				let _ = e[g];
				return _.has(s) || _.set(s, new Set), _.get(s)
			}

			function y(e, s) {
				v(e, "target").add(s), Object.defineProperty(e, s, {
					configurable: !0,
					get() {
						return c(this, s)
					}
			...
			function k(e, s) {
				v(e, "targets").add(s), Object.defineProperty(e, s, {
					configurable: !0,
					get() {
						return function(e, s) {
							let _ = e.tagName.toLowerCase(),
								t = [];
							if (e.shadowRoot)
								for (let n of e.shadowRoot.querySelectorAll(`[data-targets~="${_}.${s}"]`)) n.closest(_) || t.push(n);
							for (let n of e.querySelectorAll(`[data-targets~="${_}.${s}"]`)) n.closest(_) === e && t.push(n);
							return t
						}(this, s)
					}
				})
			...
			let W = new Map,
				...
				w = new Promise(e => {
					...
					let _ = {
						...
						t = () => s.abort();
					document.addEventListener("mousedown", t, _), document.addEventListener("touchstart", t, _), document.addEventListener("keydown", t, _), document.addEventListener("pointerdown", t, _)
				}),
				P = {
					ready: () => x,
					firstInteraction: () => w,
					visible: e => new Promise(s => {
						let _ = new IntersectionObserver(e => {
							for (let t of e)
								if (t.isIntersecting) {
									s(), _.disconnect();
									return
						...
						for (let s of document.querySelectorAll(e)) _.observe(s)
					})
				},
				q = new WeakMap;

			function A(e) {
				cancelAnimationFrame(q.get(e) || 0), q.set(e, requestAnimationFrame(() => {
					for (let s of W.keys()) {
						let _ = e.matches(s) ? e : e.querySelector(s);
						if (customElements.get(s) || _) {
							let t = _?.getAttribute("data-load-on") || "ready",
								n = t in P ? P[t] : P.ready;
							for (let e of W.get(s) || []) n(s).then(e);
							W.delete(s), q.delete(e)
						}
					}
				}))
			}
			...
			function z(e, s) {
				W.has(e) || W.set(e, new Set), W.get(e).add(s), A(document.body), t || (t = new MutationObserver(e => {
					if (W.size)
						for (let s of e)
							for (let e of s.addedNodes) e instanceof Element && A(e)
				})).observe(document, {
					subtree: !0,
					childList: !0
				})
...
//# sourceMappingURL=element-registry-9674b8685660.js.map