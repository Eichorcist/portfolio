...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["ui_packages_soft-nav_soft-nav_ts"], {
		15345: (e, t, n) => {
			n.d(t, {
				N: () => o,
				x: () => a
			...
			function o(e, t) {
				a((e.getAttribute("aria-label") || e.innerText || "").trim(), t)
			}
			...
			function a(e, t) {
				...
				! function(e, t) {
					let n = r.n4?.querySelector(t ? "#js-global-screen-reader-notice-assertive" : "#js-global-screen-reader-notice");
				...
				return {
					getItem: function(e, t = new Date().getTime()) {
						try {
							...
							if (o && t > o) return d(e), d(r), l("SAFE_STORAGE_VALUE_EXPIRED"), null;
							return l("SAFE_STORAGE_VALUE_WITHIN_TTL"), i(n)
						} catch (e) {
							return null
						}
					},
		...
		15981: (e, t, n) => {
			...
			function l() {
				(0, r.LS)(s, "0"), (0, r.cl)(c), (0, r.cl)(a), (0, r.cl)(i), (0, r.cl)(u)
			}
			...
			let h = Object.freeze({
				...
				g = class SoftNavEvent extends Event {
					constructor(e, t) {
						super(t), this.mechanism = e
					}
				};
			let SoftNavStartEvent = class SoftNavStartEvent extends g {
				constructor(e) {
					super(e, h.START)
				}
			};
			let SoftNavSuccessEvent = class SoftNavSuccessEvent extends g {
				constructor(e, t) {
					super(e, h.SUCCESS), this.visitCount = t
				}
			};
			let SoftNavErrorEvent = class SoftNavErrorEvent extends g {
				constructor(e, t) {
					super(e, h.ERROR), this.error = t
				}
			};
			let SoftNavEndEvent = class SoftNavEndEvent extends g {
				constructor(e) {
					super(e, h.END)
				}
			};
			var R = n(71643);
			let w = "stats:soft-nav-duration",
				y = {
					turbo: "TURBO",
					react: "REACT",
					"turbo.frame": "FRAME",
			...
			function N() {
				T = 0, document.dispatchEvent(new Event(h.INITIAL)), l()
			}

			function b(e) {
				f() || (document.dispatchEvent(new Event(h.PROGRESS_BAR.START)), document.dispatchEvent(new SoftNavStartEvent(e)), d(e), function() {
					let e = p();
					e ? (0, r.LS)(u, e) : (0, r.cl)(u)
				}(), (0, r.LS)(c, window.location.href), performance.clearResourceTimings(), performance.mark(w))
			}

			function A(e = {}) {
				x(e) && (T += 1, document.dispatchEvent(new SoftNavSuccessEvent(v(), T)), I(e))
			}
			...
			function L(e = {}) {
				...
				T = 0;
				let t = (0, r.rV)(a) || o;
				document.dispatchEvent(new SoftNavErrorEvent(v(), t)), _(), (0, R.b)({
					turboFailureReason: t,
					turboStartUrl: S(),
			...
			function I(e = {}) {
				x(e) && (_(), document.dispatchEvent(new SoftNavEndEvent(v())), (0, r.LS)(s, "0"))
			}

			function C(e = {}) {
				x(e) && (! function() {
					let e = function() {
						if (0 === performance.getEntriesByName(w).length) return null;
						performance.measure(w, w);
						let e = performance.getEntriesByName(w),
							t = e.pop();
					...
					let t = y[v()],
						n = Math.round(e);
					t === y.react && document.dispatchEvent(new CustomEvent("staffbar-update", {
						detail: {
							duration: n
						}
					})), (0, R.b)({
						...
						softNavigationTiming: {
							...
							destination: p() || "rails",
							duration: n,
							initiator: (0, r.rV)(u) || "rails"
						}
					})
				}(), document.dispatchEvent(new Event(h.RENDER)))
			}

			function O() {
				document.dispatchEvent(new Event(h.FRAME_UPDATE))
			}

			function _() {
				document.dispatchEvent(new Event(h.PROGRESS_BAR.END))
			}
			...
			function x({
				...
				return f() && (0 === t.length || t.includes(v())) && (!e || !p())
			}
			var D = n(15345),
				U = n(86283);
			let k = Object.freeze({
			...
			function P() {
				U.n4?.addEventListener(h.SUCCESS, function(e) {
					"turbo" === e.mechanism && D.x(`${document.title}`)
				}), U.n4?.addEventListener(k.INITIAL, N), U.n4?.addEventListener(k.START, e => {
					b(e.detail.mechanism)
				}), U.n4?.addEventListener(k.SUCCESS, () => A()), U.n4?.addEventListener(k.ERROR, () => L()), U.n4?.addEventListener(k.RENDER, () => C())
			}

			function B() {
				"undefined" != typeof navigation && "undefined" != typeof NavigateEvent && "function" == typeof NavigateEvent.prototype?.intercept && document.addEventListener(h.PROGRESS_BAR.START, () => {
					let e = new Promise(e => {
						document.addEventListener(h.PROGRESS_BAR.END, e, {
							once: !0
						})
					});
					navigation.addEventListener("navigate", t => {
						t.canIntercept && t.intercept({
							scroll: "manual",
							handler: () => (history.replaceState(navigation.currentEntry.getState(), "", location.href), e)
						})
					}, {
						once: !0
		...
		71643: (e, t, n) => {
			...
			function s(e, t = !1, n = 1) {
				if (!0 !== (0, i.c)("BROWSER_STATS_DISABLED")) {
					...
					void 0 === e.timestamp && (e.timestamp = new Date().getTime()), e.loggedIn = !!r.n4?.head?.querySelector('meta[name="user-login"]')?.content, e.staff = f(), e.bundler = a.A7, Math.random() < n && c.push(e), t ? d() : l()
				}
			}
			let u = null;
			async function l() {
				await o.C, null == u && (u = window.requestIdleCallback(d))
			}

			function d() {
				if (u = null, !c.length) return;
			...
			r.n4?.addEventListener("pagehide", d), r.n4?.addEventListener("visibilitychange", d)
		}
	}
]);
//# sourceMappingURL=ui_packages_soft-nav_soft-nav_ts-89f7d5e501ca.js.map