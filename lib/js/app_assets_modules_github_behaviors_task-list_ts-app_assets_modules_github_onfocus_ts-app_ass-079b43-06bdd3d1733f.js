...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["app_assets_modules_github_behaviors_task-list_ts-app_assets_modules_github_onfocus_ts-app_ass-079b43"], {
		48804: (e, t, n) => {
			n.d(t, {
				L$: () => u,
				SE: () => L,
			...
			function f(e, t, n) {
				...
				i.setAttribute("type", "hidden"), i.setAttribute("name", "task_list_track"), i.setAttribute("value", t), s.appendChild(i);
				let o = document.createElement("input");
				if (o.setAttribute("type", "hidden"), o.setAttribute("name", "task_list_operation"), o.setAttribute("value", JSON.stringify(n)), s.appendChild(o), !s.elements.namedItem("task_list_key")) {
			...
			}(0, o.N7)(".js-task-list-container .js-task-list-field", function(e) {
				let t = e.closest(".js-task-list-container");
				u(t), A(t)
			}), (0, o.N7)(".js-convert-tasklist-to-block-enabled .contains-task-list", function(e) {
				let t = q(e);
				if (!t) return;
				...
				n && (l && n.json.source && (s.querySelector(".js-task-list-field").value = n.json.source), u(s), requestAnimationFrame(() => A(s)))
			});
			let m = !1,
				p = !1,
				h = null;
			...
			function g(e) {
				...
				(function(e) {
					let t = function(e, t) {
						...
						h.startsWith(m) && (m = "");
						let b = r.replace(i, "").trim().length > 0 || h.trim().length > 0;
						if (b) {
							let t = `${o}${m}`,
								s = e.substring(n),
								r = t.length,
								l = [null, null],
								i = e.substring(0, n) + t + s;
							if (d && !e.substring(n).match(/^\s*$/g)) {
								...
								g = e.substring(n), y = c + 1, t += s = g.split("\n").map(e => {
									...
									return e
								}).join("\n"), l = [n, n + t.length], i = e.substring(0, n) + t
							}
							return {
								text: i,
...
${i}`;
							return {
								text: e.substring(0, n) + o + e.substring(n),
								autocompletePrefix: o,
								selection: [n + o.length, n + o.length],
								commandId: "insertText",
								writeSelection: [null, null]
							}
			...
			function E(e) {
				...
				let t = e.target,
					n = function(e, t, n) {
						...
						let m = f.join("\n"),
							p = e.substring(0, l) + m + e.substring(o),
		...
		254: (e, t, n) => {
			...
			function o(e, t) {
				r || (r = !0, document.addEventListener("focus", i, !0)), l.add(e, t), document.activeElement instanceof HTMLElement && document.activeElement.matches(e) && t(document.activeElement)
			}
		...
		40458: (e, t, n) => {
			...
			async function i() {
				...
				if (i.ssoComplete = function(e) {
						...
						}(e.expiresAround), window.focus()), i.ssoComplete = null
					}, await new Promise(e => {
			...
			async function u() {
				let e = await o();
				e || (a || (a = i().then(c).catch(c)), await a)
			}
		},
		54177: (e, t, n) => {
			n.d(t, {
		...
		82873: (e, t, n) => {
			...
			var l = n(22490),
				i = n(7180);
			let o = "server-x-safe-html",
				a = l.ZO.createPolicy(o, {
					createHTML: (e, t) => i.O.apply({
			...
			async function c(e, t, n) {
				...
				let i = a.createHTML(await l.text(), l);
				return (0, s.r)(e, i)
			}

			function u(e, t, n = 1e3, s = [200], r = [202]) {
				return async function n(l) {
					let i = new Request(e, t);
					i.headers.append("X-Requested-With", "XMLHttpRequest");
					let o = await self.fetch(i);
					if (r.includes(o.status)) return await new Promise(e => setTimeout(e, l)), n(1.5 * l);
					if (s.includes(o.status)) return o;
					if (o.status < 200 || o.status >= 300) throw Error(`HTTP ${o.status}${o.statusText||""}`);
					throw Error(`Unexpected ${o.status} response status from poll endpoint`)
				}(n)
			}
			async function d(e, t, n) {
				let {
					...
					max: l = 3,
					attempt: i = 0
				} = n || {}, o = async () => new Promise((n, o) => {
					setTimeout(async () => {
						try {
							let s = new Request(e, t);
							s.headers.append("X-Requested-With", "XMLHttpRequest");
							let o = await self.fetch(s);
							if (r.includes(o.status) || i + 1 === l) return n(o);
							n("retry")
						} catch (e) {
							o(e)
						}
		...
		76134: (e, t, n) => {
			...
			let l = () => {
				...
				o = new Set(["button", "checkbox", "color", "file", "hidden", "image", "radio", "range", "reset", "submit"]),
				a = e => {
					let t = (0, r.EL)(e),
						n = function(e) {
							...
							return ("select" === t || "textarea" === t || "input" === t && !o.has(n) || e.isContentEditable) && !s
...
//# sourceMappingURL=app_assets_modules_github_behaviors_task-list_ts-app_assets_modules_github_onfocus_ts-app_ass-079b43-9a9c92717a3d.js.map