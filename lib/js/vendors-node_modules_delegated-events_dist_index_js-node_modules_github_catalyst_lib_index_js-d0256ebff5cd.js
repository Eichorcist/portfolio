...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["vendors-node_modules_delegated-events_dist_index_js-node_modules_github_catalyst_lib_index_js"], {
		59753: (e, t, n) => {
			function o() {
			...
			var r, a = window.document.documentElement,
				i = a.matches || a.webkitMatchesSelector || a.mozMatchesSelector || a.oMatchesSelector || a.msMatchesSelector;
			...
			function u(e, t) {
				var n, o, r, a, i, s, l = (e = e.slice(0).concat(e.default)).length,
					c = t,
					u = [];
				do
					if (d.exec(""), (r = d.exec(c)) && (c = r[3], r[2] || !c)) {
						for (n = 0; n < l; n++)
							if (i = (s = e[n]).selector(r[1])) {
								for (o = u.length, a = !1; o--;)
									if (u[o].index === s && u[o].key === i) {
										a = !0;
										break
									} a || u.push({
									index: s,
			...
			o.prototype.logDefaultIndexUsed = function() {}, o.prototype.add = function(e, t) {
				var n, o, a, i, s, l, c, d, f = this.activeIndexes,
					h = this.selectors,
				...
				if ("string" == typeof e) {
					for (o = 0, p[(n = {
							...
							selector: e,
							data: t
						}).id] = n, c = u(this.indexes, e); o < c.length; o++) i = (d = c[o]).key, (s = function(e, t) {
						var n, o, r;
						for (n = 0, o = e.length; n < o; n++)
							if (r = e[n], t.isPrototypeOf(r)) return r
					}(f, a = d.index)) || ((s = Object.create(a)).map = new r, f.push(s)), a === this.indexes.default && this.logDefaultIndexUsed(n), (l = s.map.get(i)) || (l = [], s.map.set(i, l)), l.push(n);
					this.size++, h.push(e)
				}
			}, o.prototype.remove = function(e, t) {
				if ("string" == typeof e) {
					var n, o, r, a, i, s, l, c, d = this.activeIndexes,
						f = this.selectors = [],
						h = this.selectorObjects,
						p = {},
						g = 1 == arguments.length;
					for (r = 0, n = u(this.indexes, e); r < n.length; r++)
						for (o = n[r], a = d.length; a--;)
							if (s = d[a], o.index.isPrototypeOf(s)) {
								if (l = s.map.get(o.key))
									for (i = l.length; i--;)(c = l[i]).selector === e && (g || c.data === t) && (l.splice(i, 1), p[c.id] = !0);
								break
				...
				var t, n, o, r, a, i, s, l, c = {},
					d = [],
					u = this.querySelectorAll(this.selectors.join(", "), e);
				for (t = 0, o = u.length; t < o; t++)
					for (n = 0, a = u[t], r = (i = this.matches(a)).length; n < r; n++) c[(l = i[n]).id] ? s = c[l.id] : (s = {
						id: l.id,
						selector: l.selector,
						data: l.data,
						elements: []
					}, c[l.id] = s, d.push(s)), s.elements.push(a);
				return d.sort(f)
			}, o.prototype.matches = function(e) {
				if (!e) return [];
				var t, n, o, r, a, i, s, l, c, d, u, h = this.activeIndexes,
					p = {},
					g = [];
				for (t = 0, r = h.length; t < r; t++)
					if (l = (s = h[t]).element(e)) {
						for (n = 0, a = l.length; n < a; n++)
							if (c = s.map.get(l[n]))
								for (o = 0, i = c.length; o < i; o++) !p[u = (d = c[o]).id] && this.matchesSelector(e, d.selector) && (p[u] = !0, g.push(d))
					} return g.sort(f)
			};
			var h = {},
				p = {},
			...
			function S(e) {
				if (function(e) {
					...
					if (t) {
						...
						if (n.length) {
							v(e, "stopPropagation", w), v(e, "stopImmediatePropagation", A), k(e, x);
							for (var o = 0, r = n.length; o < r && !g.get(e); o++) {
								var a = n[o];
								m.set(e, a.node);
								for (var i = 0, s = a.observers.length; i < s && !b.get(e); i++) a.observers[i].data.call(a.node, e)
							}
							m.delete(e), k(e)
						}
					}
			...
			function E(e, t, n) {
				var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
					...
					i = a ? p : h,
					s = i[e];
				s || (s = new o, i[e] = s, document.addEventListener(e, S, a)), s.add(t, n)
			}
			...
			function C(e, t, n) {
				var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
					...
					a = r ? p : h,
					i = a[e];
				i && (i.remove(t, n), i.size || (delete a[e], document.removeEventListener(e, S, r)))
			}
		...
		76006: (e, t, n) => {
			...
			let CatalystDelegate = class CatalystDelegate {
				...
				connectedCallback(e, t) {
					...
					}(e), m(e), r.add(e), e.shadowRoot && (s(o = e.shadowRoot), i(o)), s(e), i(e.ownerDocument), t?.call(e), e.shadowRoot && (s(n = e.shadowRoot), i(n))
				}
			...
			function P(e) {
				cancelAnimationFrame(O.get(e) || 0), O.set(e, requestAnimationFrame(() => {
					for (let t of k.keys()) {
						...
						if (customElements.get(t) || n) {
							...
							for (let e of k.get(t) || []) r(t).then(e);
							k.delete(t), O.delete(e)
						}
					}
				}))
			}
			...
			function j(e, t) {
				k.has(e) || k.set(e, new Set), k.get(e).add(t), P(document.body), o || (o = new MutationObserver(e => {
					if (k.size)
						for (let t of e)
...
//# sourceMappingURL=vendors-node_modules_delegated-events_dist_index_js-node_modules_github_catalyst_lib_index_js-ad2f3c5ecf4f.js.map