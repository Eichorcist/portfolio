...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["vendors-node_modules_github_remote-form_dist_index_js-node_modules_delegated-events_dist_inde-94fd67"], {
		65935: (e, t, n) => {
			let r;
			n.d(t, {
				AC: () => u,
			...
			function u(e, t) {
				r || (r = new Map, "undefined" != typeof document && document.addEventListener("submit", c));
				let n = r.get(e) || [];
				r.set(e, [...n, t])
			}
			...
			function c(e) {
				...
				let a = function(e) {
					...
					[l, u, c] = i();
				e.preventDefault(), p(n, t, a, l).then(async e => {
					if (e) {
						for (let e of s) await e(t);
						h(a).then(u, c).catch(() => {}).then(() => {
							for (let e of o) e(t)
						})
					} else t.submit()
				}, e => {
			...
			async function h(e) {
				let t = await window.fetch(e.url, {
					...
					n = {
						...
						text: "",
						get json() {
							let e = JSON.parse(this.text);
							return delete this.json, this.json = e, this.json
						},
						get html() {
							return delete this.html, this.html = function(e, t) {
		...
		59753: (e, t, n) => {
			...
			var i, o = window.document.documentElement,
					...
					if (c.exec(""), (i = c.exec(u)) && (u = i[3], i[2] || !u)) {
						for (n = 0; n < l; n++)
							if (s = (a = e[n]).selector(i[1])) {
								for (r = p.length, o = !1; r--;)
									if (p[r].index === a && p[r].key === s) {
										o = !0;
										break
									} o || p.push({
									index: a,
			...
			r.prototype.logDefaultIndexUsed = function() {}, r.prototype.add = function(e, t) {
				var n, r, o, s, a, l, u, c, h = this.activeIndexes,
					f = this.selectors,
				...
				if ("string" == typeof e) {
					for (r = 0, d[(n = {
							...
							selector: e,
							data: t
						}).id] = n, u = p(this.indexes, e); r < u.length; r++) s = (c = u[r]).key, (a = function(e, t) {
						var n, r, i;
						for (n = 0, r = e.length; n < r; n++)
							if (i = e[n], t.isPrototypeOf(i)) return i
					}(h, o = c.index)) || ((a = Object.create(o)).map = new i, h.push(a)), o === this.indexes.default && this.logDefaultIndexUsed(n), (l = a.map.get(s)) || (l = [], a.map.set(s, l)), l.push(n);
					this.size++, f.push(e)
				}
				...
				if ("string" == typeof e) {
					...
					for (i = 0, n = p(this.indexes, e); i < n.length; i++)
						for (r = n[i], o = c.length; o--;)
							if (a = c[o], r.index.isPrototypeOf(a)) {
								if (l = a.map.get(r.key))
									for (s = l.length; s--;)(u = l[s]).selector === e && (m || u.data === t) && (l.splice(s, 1), d[u.id] = !0);
								break
				...
				var t, n, r, i, o, s, a, l, u = {},
					c = [],
					p = this.querySelectorAll(this.selectors.join(", "), e);
				for (t = 0, r = p.length; t < r; t++)
					for (n = 0, o = p[t], i = (s = this.matches(o)).length; n < i; n++) u[(l = s[n]).id] ? a = u[l.id] : (a = {
						id: l.id,
						selector: l.selector,
						data: l.data,
						elements: []
					}, u[l.id] = a, c.push(a)), a.elements.push(o);
				return c.sort(h)
			}, r.prototype.matches = function(e) {
				if (!e) return [];
				var t, n, r, i, o, s, a, l, u, c, p, f = this.activeIndexes,
					d = {},
					m = [];
				for (t = 0, i = f.length; t < i; t++)
					if (l = (a = f[t]).element(e)) {
						for (n = 0, o = l.length; n < o; n++)
							if (u = a.map.get(l[n]))
								for (r = 0, s = u.length; r < s; r++) !d[p = (c = u[r]).id] && this.matchesSelector(e, c.selector) && (d[p] = !0, m.push(c))
					} return m.sort(h)
			};
			var f = {},
				d = {},
			...
			function E(e) {
				if (function(e) {
					...
					var t = (1 === e.eventPhase ? d : f)[e.type];
					if (t) {
						var n = function(e, t, n) {
							...
							} while (i = i.parentElement) return r
						}(t, e.target, 1 === e.eventPhase);
						if (n.length) {
							b(e, "stopPropagation", w), b(e, "stopImmediatePropagation", x), T(e, S);
							for (var r = 0, i = n.length; r < i && !m.get(e); r++) {
								var o = n[r];
								v.set(e, o.node);
			...
			function k(e, t, n) {
				var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
					...
					s = o ? d : f,
					a = s[e];
				a || (a = new r, s[e] = a, document.addEventListener(e, E, o)), a.add(t, n)
			}
			...
			function C(e, t, n) {
				var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
					...
					o = i ? d : f,
					s = o[e];
				s && (s.remove(t, n), s.size || (delete o[e], document.removeEventListener(e, E, i)))
			}
		...
		69567: (e, t, n) => {
			...
			var i, o, s, a, l, u = function(e, t, n) {
			...
			let AttributeTemplatePart = class AttributeTemplatePart {
				constructor(e, t) {
					this.expression = t, i.set(this, void 0), o.set(this, ""), u(this, i, e), c(this, i).updateParent("")
				}
				get attributeName() {
				...
				set value(e) {
					u(this, o, e || ""), c(this, i).updateParent(e)
				}
				get element() {
			...
			let NodeTemplatePart = class NodeTemplatePart {
				constructor(e, t) {
					this.expression = t, s.set(this, void 0), p(this, s, [e]), e.textContent = ""
				}
				get value() {
					return h(this, s).map(e => e.textContent).join("")
				}
				set value(e) {
					this.replace(e)
				}
				get previousSibling() {
					return h(this, s)[0].previousSibling
				}
				get nextSibling() {
					return h(this, s)[h(this, s).length - 1].nextSibling
				}
				replace(...e) {
					let t = e.map(e => "string" == typeof e ? new Text(e) : e);
					for (let e of (t.length || t.push(new Text("")), h(this, s)[0].before(...t), h(this, s))) e.remove();
					p(this, s, t)
				}
			};
			...
			let TemplateInstance = class TemplateInstance extends DocumentFragment {
				constructor(e, t, n = m) {
					var i, o;
					super(), a.set(this, void 0), l.set(this, void 0), Object.getPrototypeOf(this !== TemplateInstance.prototype) && Object.setPrototypeOf(this, TemplateInstance.prototype), this.appendChild(e.content.cloneNode(!0)), v(this, l, Array.from(function*(e) {
						let t;
					...
					}(this))), v(this, a, n), null === (o = (i = y(this, a)).createCallback) || void 0 === o || o.call(i, this, y(this, l), t)
				}
				update(e) {
					y(this, a).processCallback(this, y(this, l), e)
				}
			};
...
//# sourceMappingURL=vendors-node_modules_github_remote-form_dist_index_js-node_modules_delegated-events_dist_inde-94fd67-ffac241319d7.js.map