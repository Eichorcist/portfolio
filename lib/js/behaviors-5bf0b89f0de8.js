	...
	["behaviors"], {
		84817: (e, t, n) => {
			...
			(0, w.on)("submit", "[data-autosearch-results-container]", async function(e) {
				...
				e.preventDefault(), D?.abort(), t.classList.add("is-sending");
				...
				let {
					signal: l
				} = D = new AbortController, c = new Request(n.toString(), {
					method: i,
					body: s,
					signal: l,
					headers: {
				...
				if (m) {
					...
					let t = m.hasAttribute("data-delay-results"),
						n = await u.text(),
						i = (0, $.r)(document, n).querySelector("[data-autosearch-results]") || (0, $.r)(document, n).firstElementChild;
					r = setTimeout(() => {
						m.appendChild((0, $.r)(document, n)), (0, C.N)(i), requestAnimationFrame(() => {
							m.style.height = e
						})
					}, t ? 500 : 0)
				}(0, I.lO)(null, "", `?${o}`)
			...
			async function Q(e) {
				let t = e.getAttribute("data-item-name") || "items",
					...
					o = parseInt(e.getAttribute("data-item-maximum")) || 1e6,
				...
				m && i.append("transform_user", "1"), r.search = i.toString(), Y?.abort();
				let {
					signal: f
				} = Y = new AbortController, h = null;
				try {
			...
			function et(e, t = !1) {
				...
				for (let e of (function(e) {
					...
					}(n), document.querySelectorAll(".js-seat-field"))) Q(e);
				(function() {
				...
				(0, K.softNavigate)(t.toString())
			}), (0, T.N7)(".js-addon-purchase-field", {
				constructor: HTMLInputElement,
				add(e) {
					(0, Z.Z)(e) && Q(e), (0, G.oq)(e, function() {
						Q(e)
					})
				}
				...
				add(e) {
					(0, Z.Z)(e) && Q(e), e.addEventListener("change", function() {
						Q(e)
					})
				}
				...
				if (t instanceof HTMLInputElement && n instanceof HTMLInputElement) {
					...
					e && (t.setAttribute("data-url", e), t.value = "0", Q(t))
				}
			}, {
				capture: !0
...
`
			...
			function eX(e) {
				...
				ez("uploading", "", e)
			}), (0, w.on)("upload:complete", ".js-upload-markdown-image", eO), (0, w.on)("upload:error", ".js-upload-markdown-image", function(e) {
				eU(e);
				let {
					batch: t
				} = e.detail;
				t.isFinished() ? eD(e) : eI(e)
			...
			async function e0(e, t) {
				...
				let {
					signal: n
				} = eQ = new AbortController, r = await fetch(e, {
					method: "post",
					body: t,
					signal: n
				});
			...
			(0, w.on)("navigation:keydown", ".js-commits-list-item", function(e) {
				(0, e3.Zf)(e.detail.originalEvent) && e.target instanceof Element && "c" === e.detail.hotkey && e.target.querySelector(".js-navigation-open").click()
			...
			async function e8({
				...
				}(0, w.f)(e, t ? "menu:activate" : "menu:deactivate"), await (0, O.gJ)(), (0, w.f)(e, t ? "menu:activated" : "menu:deactivated")
				...
				capture: !0
			}), (0, w.on)("details-menu-selected", "[data-menu-input]", e => {
			...
			function tr(e) {
				for (let t of tt(e)) {
					let n = te.get(t);
					null != n && (tn(t, n), (!t.hasAttribute("data-disable-invalid") || e.checkValidity()) && (t.disabled = !1), te.delete(t))
				}
			}(0, w.on)("submit", "form", function(e) {
				let t = e.currentTarget;
				for (let e of tt(t)) {
					te.set(e, e instanceof HTMLInputElement ? e.value || "Submit" : e.innerHTML || "");
					let t = e.getAttribute("data-disable-with");
					t && tn(e, t), e.disabled = !0
				}
			}, {
				capture: !0
			...
			async function tc(e) {
				...
				add(e) {
					...
					setTimeout(() => ta(t, to() ? "dark" : "light"))
				},
				remove() {
					null != i && ta(i, to() ? "dark" : "light")
				}
			}), ts(), document.addEventListener(ti.QE.SUCCESS, ts), window.matchMedia("(prefers-color-scheme: dark)").addListener(() => {
				ta(void 0, to() ? "dark" : "light")
			...
			async function tf(e, t) {
				let n = {
					attachmentUploadDidStart(n, r) {
						n.saving(0), ty(t, "is-uploading"), (0, w.f)(t, "upload:start", {
							batch: e,
							attachment: n,
							policy: r
						})
			...
			function tp(e, t) {
				...
				async process(e) {
					...
					})), 204 === i.status ? (tm(this.policy), e.attachmentUploadDidComplete(this.attachment, this.policy, {})) : 201 === i.status ? (tm(this.policy), e.attachmentUploadDidComplete(this.attachment, this.policy, JSON.parse(i.responseText))) : e.attachmentUploadDidError(this.attachment, {
						status: i.status,
						body: i.responseText
					});
			...
			let tg = e => e.startsWith("size") ? e.substring(5) : e,
				tb = ["is-default", "is-uploading", "is-bad-file", "is-duplicate-filename", "is-too-big", "is-too-many", "is-hidden-file", "is-failed", "is-bad-dimensions", "is-empty", "is-bad-permissions", "is-repository-required", "is-bad-format"];
			...
			function ty(e, t, n) {
				...
				e.classList.remove(...tb), e.classList.add(t)
			}
			...
			h = class Batch {
				percent() {
					let e = tv(this.attachments, e => e.file.size * e.percent / 100);
					return Math.round(e / this.total * 100)
				}
				uploaded() {
					return tv(this.attachments, e => e.isSaved() ? 1 : 0)
				}
				isFinished() {
				...
				constructor(e) {
					this.attachments = e, this.failedAttachments = [], this.size = this.attachments.length, this.total = tv(this.attachments, e => e.file.size)
				}
				...
				0 === t.length && (ty(e.currentTarget, "is-hidden-file"), e.preventDefault())
			...
			function tj({
				...
				add(e) {
					0 == tw++ && (document.addEventListener("drop", tE), document.addEventListener("dragover", tL));
					let t = e.closest("form");
					t && t.addEventListener("reset", tj)
				},
				remove(e) {
					0 == --tw && (document.removeEventListener("drop", tE), document.removeEventListener("dragover", tL));
					let t = e.closest("form");
					t && t.removeEventListener("reset", tj)
				}
			});
			var tA = n(13002);
			...
			function tq(e, t) {
				...
				n instanceof tA.Z && n.setAttribute("aria-owns", t.id)
			}, {
				capture: !0
			});
			var tk = n(87738),
			...
			function tx(e, t, n) {
				...
				} else a = Array.from(e.children), tM.set(e, a);
				for (let t of s) e.removeChild(t), t instanceof HTMLElement && (t.style.display = "");
				let l = r ? (0, tC.W)(a, n.sortKey, tk.qu) : a,
			...
			async function tI(e, t, n) {
				...
				if (n) {
					...
					if (tR.abort(), "" === i) n.lastSearchResult = {
						suggestions: [],
						users: []
					};
					else {
			...
			async function tV(e, t) {
				...
				tO.abort(), tO = new AbortController;
				let s = {
						headers: {
							Accept: "application/json",
							"X-Requested-With": "XMLHttpRequest"
			...
			function tZ(e, t) {
				...
				initialize(e) {
					...
					let t = e.hasAttribute("type-ahead") ? 200 : null,
						n = e.value;
					async function r(e) {
						n !== e.value && (n = e.value, await (0, O.gJ)(), (0, w.f)(e, "filterable:change"))
					}
					async function i() {
						n = e.value, await (0, O.gJ)(), (0, w.f)(e, "filterable:change")
					}
					return {
						add(e) {
			...
			function tY() {
				...
				!e.classList.contains("js-skip-scroll-target-into-view") && (0, tK.lA)(document) && (0, tK.kc)(document)
			}(0, tJ.Z)(tY), (0, w.on)("click", 'a[href^="#"]', function(e) {
				let {
					currentTarget: t
				} = e;
			...
			var tQ = n(69567);
			let t0 = ["flash-notice", "flash-error", "flash-message", "flash-warn"];
			...
			document.addEventListener("focus", function(e) {
				let t = e.target;
				t instanceof Element && !t1.get(t) && ((0, w.f)(t, "focusin:delay"), t1.set(t, !0))
			}, {
				capture: !0
			}), document.addEventListener("blur", function(e) {
				setTimeout(function() {
					let t = e.target;
					t instanceof Element && t !== document.activeElement && ((0, w.f)(t, "focusout:delay"), t1.delete(t))
				}, 200)
			}, {
				capture: !0
			...
			function t2(e) {
				...
				constructor: t7.Z,
				subscribe: e => (0, F.RB)(e, "fuzzy-list-sorted", t4)
				...
				t instanceof HTMLElement && (t.style.display = "", t.classList.toggle("expanded"), e.preventDefault())
					...
					if (r && r.classList.toggle("is-custom", n), t.checked) {
						if (n) {
							...
							e.checked = !1
						} else "push" === t.value ? t2('[value="push"]') : "all" === t.value && t2(".js-hook-wildcard-event")
					}
					...
					n.before(await (0, td.a_)(document, r)), n.remove()
				...
				function() {
					...
					e && t && n && (n.addEventListener("change", n => {
						n.stopPropagation(), t.checked = !0, e.show()
			...
			(0, T.N7)("[data-hotkey]", {
				constructor: HTMLElement,
				add(e) {
					if ((0, e3.Ty)())(0, t5.N9)(e);
					else {
						let t = e.getAttribute("data-hotkey");
						if (t) {
							let n = function(e) {
								let t = (0, t5.DV)(e);
								return t.filter(e => (0, e3.YE)(e)).join(",")
							}(t);
							n.length > 0 ? (e.setAttribute("data-hotkey", n), (0, t5.N9)(e)) : (e.removeAttribute("data-hotkey"), (0, t5.Tz)(e))
						}
					}
				},
				remove(e) {
			...
			var t3 = n(29764);
			let t9 = document.querySelector(".js-hovercard-content");
			...
			function ni() {
				t9 instanceof HTMLElement && (t9.style.display = "none", t9.children[0].textContent = "", t9.removeAttribute("data-hovercard-target-url"), t8 = null, a = null)
			}
			async function na(e, t) {
				...
				if (r) return;
				let i = e.currentTarget;
				if (e instanceof MouseEvent && (nn = e.clientX), !(i instanceof Element) || a === i || i.closest(".js-hovercard-content") || ! function(e) {
				...
				ni(), a = i, t8 = document.activeElement;
				let o = function(e) {
				...
				try {
					...
					await r, a || "focusin" !== e.type || (a = e.target), i === a && (n = await t6(document, o))
				} catch (t) {
					let e = t.response;
				...
				i === a && n && (! function(e, t) {
					if (!(t9 instanceof HTMLElement)) return;
					let n = t9.children[0];
					n.textContent = "";
					...
					n.appendChild(r),
						function(e, t) {
							if (!(t9 instanceof HTMLElement)) return;
							t9.style.visibility = "hidden", t9.style.display = "block", t.classList.remove(nr("bottom-left"), nr("bottom-right"), nr("right-top"), nr("right-bottom"), nr("top-left"), nr("top-right"));
							let {
								containerTop: n,
								containerLeft: r,
							...
							t.classList.add(nr(i)), t9.style.top = `${n+window.pageYOffset}px`, t9.style.left = `${r+window.pageXOffset}px`,
								function(e, t) {
									let n = e.getAttribute("data-hovercard-z-index-override");
									n ? t.style.zIndex = n : t.style.zIndex = "100"
								}(e, t9), t9.style.visibility = ""
						}(t, n), setTimeout(() => {
							if (document.body && document.body.contains(r)) {
								let e = r.querySelector("[data-hydro-view]");
								e instanceof HTMLElement && (0, t3.Fk)(e)
							}
						}, 500), (0, C.N)(r), t9.style.display = "block", t9.setAttribute("data-hovercard-target-url", t.getAttribute("data-hovercard-url") || "")
				}(n, i), e instanceof KeyboardEvent && t9 instanceof HTMLElement && t9.focus())
			}
			...
			function no(e) {
				if (a) {
					...
					} else e instanceof KeyboardEvent && t8 instanceof HTMLElement && t8.focus();
					ni()
				}
			}

			function ns(e) {
				e instanceof KeyboardEvent && "Escape" === e.key && no(e)
			}
			...
			t9 && ((0, T.N7)("[data-hovercard-url]", {
				subscribe: e => (0, F.qC)((0, F.RB)(e, "mouseover", nm), (0, F.RB)(e, "focusin", nc), (0, F.RB)(e, "mouseleave", nd), (0, F.RB)(e, "focusout", nu), (0, F.RB)(e, "keyup", ns))
			}), (0, T.N7)("[data-hovercard-url]", {
				remove(e) {
					a === e && ni()
				}
			}), (0, T.N7)(".js-hovercard-content", {
				subscribe: e => (0, F.qC)((0, F.RB)(e, "mouseover", nf), (0, F.RB)(e, "focusin", nh), (0, F.RB)(e, "mouseleave", nd), (0, F.RB)(e, "focusout", nu), (0, F.RB)(e, "keyup", ns))
			}), (0, w.on)("menu:activated", "details", ni), window.addEventListener("turbo:load", ni), window.addEventListener("statechange", ni), window.addEventListener("focusin", nu));
			var np = n(38085);
			let ng = ["fcp", "lcp", "fid", "inp", "cls", "hpc", "ttfb"];
			async function nb() {
				await ea.C, window.requestIdleCallback(ny)
			}

			function ny() {
				(0, E.qP)("web-vital", s), s = void 0
			}
			var nv = n(46426);
			let nw = (0, L.cF)(),
				nS = nL(),
			...
			function nq(e) {
				...
				r[t.toLowerCase()] = n, (0, nv.c)("SAMPLE_NETWORK_CONN_TYPE") && (r.networkConnType = "connection" in navigator ? navigator.connection.effectiveType : "N/A"), "HPC" === t ? (r.soft = e.soft, r.ssr = e.ssr, r.mechanism = ti.CF[e.mechanism], r.lazy = e.lazy, r.alternate = e.alternate, r.hpcFound = e.found, r.hpcGqlFetched = e.gqlFetched, r.hpcJsFetched = e.jsFetched, r.headerRedesign = !!document.querySelector("header.AppHeader")) : (r.ssr = nw, r.lazy = nS, r.alternate = nE);
				let i = document.querySelector('meta[name="synthetic-test"]');
				i && (r.synthetic = !0), (0, q.b)({
						webVitalTimings: [r]
					}),
					function(e) {
						let t;
						if (document.querySelector('[data-hydrostats="publish"]')) {
							for (let n of ng)
								if (void 0 !== e[n] && e[n] < 6e4) {
									if (!t) {
										let n = document.querySelector("react-app");
										(s || (s = {}, nb()), t = s).react = !!n, t.reactApp = n?.getAttribute("app-name"), t.reactPartials = [...new Set(Array.from(document.querySelectorAll("react-partial")).map(e => e.getAttribute("partial-name") || ""))], t.ssr = e.ssr
									}
									t[n] = e[n].toPrecision(6), "hpc" === n && (t.hpcMechanism = e.mechanism, t.hpcSoft = e.soft);
									break
								}
						}
					}(r),
			...
			async function nk() {
				window.performance && window.performance.timing && window.performance.getEntriesByType && (await ea.C, await new Promise(e => setTimeout(e)), nC(), nM())
			}
			let nC = () => {
			...
			nk(), (0, np.mw)(nq), (0, np.a4)(nq), (0, np.Fu)(nq), (0, np.NO)(nq), (0, np.mr)(nq), (0, np.Yn)(nq);
			let HPCTimingEvent = class HPCTimingEvent extends Event {
				constructor(e, t, n, r, i, a, o, s, l) {
					super("hpc:timing"), this.soft = e, this.ssr = t, this.lazy = n, this.alternate = r, this.mechanism = i, this.found = a, this.gqlFetched = o, this.jsFetched = s, this.name = "HPC", this.value = performance.now() - l
				}
			};
			let nx = new AbortController;
			...
			function nR({
				...
				let n, r, i;
				nx.abort(), nx = new AbortController;
								...
								if ("childList" === e.type) {
									for (let t of e.addedNodes)
										if (t instanceof Element) {
											if (t.hasAttribute("data-hpc") || t.querySelector("[data-hpc]")) {
												cancelAnimationFrame(n), s = !0;
												break
											}("function" == typeof t.checkVisibility ? t.checkVisibility() : !!(t.offsetParent || t.offsetWidth || t.offsetHeight)) && (cancelAnimationFrame(n), c = !0)
										} if (s) break
								} s ? (window.performance.measure("HPC", "navigationStart"), l.disconnect(), r = requestAnimationFrame(() => {
								o.dispatchEvent(new HPCTimingEvent(e, (0, L.cF)(), nL(), nj(), t, !0, nA(), nT(), a))
							})) : c && (n = requestAnimationFrame(() => {
								o.dispatchEvent(new Event("hpc:dom-insertion"))
							}))
						}
					});
				l.observe(document, {
				...
				let d = !1;
				o.addEventListener("hpc:dom-insertion", () => {
					d = !0, clearTimeout(i);
					let n = new HPCTimingEvent(e, (0, L.cF)(), nL(), nj(), t, !1, nA(), nT(), a);
					i = setTimeout(() => o.dispatchEvent(n), 1e4)
				}, {
					signal: nx.signal
				}), o.addEventListener("hpc:timing", e => {
					!s && e.value < 6e4 && nq(e), nx.abort()
				}, {
					signal: nx.signal
				}), nx.signal.addEventListener("abort", () => {
					...
					d || n_(e, !1)
				}, 1e4), !e && document.querySelector("[data-hpc]") && (n_(e, !0), nx.abort())
			}
			async function nN() {
				if (!1 === (0, nv.c)("IMAGE_METRIC_TRACKING")) return;
				let e = Array.from(document.querySelectorAll("img.js-img-time")).slice(0, 5),
					t = Date.now(),
					n = [];
				await Promise.all(e.map(e => nH(e, t, n))), n.length > 0 && (0, q.b)({
			...
			document.addEventListener(ti.QE.START, ({
				mechanism: e
			}) => {
				nR({
					soft: !0,
				...
				document.addEventListener(ti.QE.FRAME_UPDATE, () => (0, E.YT)({
					turbo: "true"
				})), document.addEventListener(ti.QE.SUCCESS, () => {
					"turbo.frame" !== (0, ti.Gj)() && (0, E.YT)({
						turbo: "true"
					})
				}), await ea.C, (0, E.YT)()
			...
			function nI() {
				...
				constructor: HTMLInputElement,
				add(e) {
					e.addEventListener("focusin", nI, {
						once: !0
					}), (0, n$.Nc)(window.location.pathname)
				}
			});
			let nD = !1;
			async function nO() {
			...
			function nB(e) {
			...
			}(0, w.on)("click", ".js-keyboard-shortcuts", nO), (0, nv.c)("react_keyboard_shortcuts_dialog") || document.addEventListener("keydown", e => {
				!(e instanceof KeyboardEvent) || !(0, e3.Zf)(e) || e.target instanceof Node && (0, P.sw)(e.target) || "Shift+?" !== (0, t5.EL)(e) || nO()
			...
			}), (0, T.N7)(".js-modifier-label-key", {
				add(e) {
					let t = e.textContent?.replace(/ctrl/i, "Ctrl");
					t && (/Macintosh/.test(navigator.userAgent) && (t = (t = t.replace(/ctrl/i, "Cmd")).replace(/alt/i, "Option")), e.textContent = t)
				}
			}), (0, T.N7)(".js-length-limited-input", {
				add(e) {
					e.addEventListener("input", nB), e.addEventListener("change", nB)
				},
				remove(e) {
					e.removeEventListener("input", nB), e.removeEventListener("change", nB)
				}
				...
				let t = e.currentTarget;
				try {
					(0, I.lO)(null, "", t.href + window.location.hash)
				} catch (e) {
			...
			let nW = null,
				nF = "last_turbo_request",
				nU = "turbo_start",
				nz = "turbo_end";
			async function nV() {
				if (await (0, O.gJ)(), !window.performance.getEntriesByName(nU).length) return;
				window.performance.mark(nz), window.performance.measure(nF, nU, nz);
				let e = window.performance.getEntriesByName(nF),
					t = e.pop(),
					n = t ? t.duration : null;
				n && (nW && (0, q.b)({
					requestUrl: nW,
					turboDuration: Math.round(n)
				}), window.performance.clearMarks(nU), window.performance.clearMarks(nz), window.performance.clearMeasures(nF))
			}
			"getEntriesByName" in window.performance && (document.addEventListener("turbo:before-fetch-request", function(e) {
				e instanceof CustomEvent && e.detail?.url && !e.defaultPrevented && (window.performance.mark(nU), nW = e.detail.url)
			}), document.addEventListener("turbo:render", nV)), (0, T.N7)("body.js-print-popup", () => {
...
${r}\`\`\``, i
			...
			(0, w.on)("click", ".js-comment-quote-reply", function({
				...
				let i = n.closest(".js-comment"),
					...
					s = i.closest(".js-quote-selection-container"),
					c = a.querySelectorAll("button.js-convert-to-issue-button, span.js-clear");
				for (let e of c) e.remove();
				if (s.hasAttribute("data-quote-markdown") && (r = new nX.I(s.getAttribute("data-quote-markdown") || "", e => {
						...
						if (n instanceof HTMLElement) {
							...
							let t = document.createNodeIterator(e, NodeFilter.SHOW_ELEMENT, {
									acceptNode: e => e.nodeName in nZ && ("IMG" === e.nodeName || null != e.firstChild) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP
								}),
								n = [],
								r = t.nextNode();
							for (; r;) r instanceof HTMLElement && n.push(r), r = t.nextNode();
							for (let e of (n.reverse(), n)) e.replaceWith(nZ[e.nodeName](e))
						}(e)
					})), l && a.contains(l.anchorNode) && !l.range.collapsed && "" !== l.range.toString().trim() ? r.range = l.range : (r.range.collapsed || "" === r.range.toString().trim()) && r.select(a), r.closest(".js-quote-selection-container") !== s) return;
				let u = r.range;
				for (let e of (s.dispatchEvent(new CustomEvent("quote-selection", {
						bubbles: !0,
						detail: r
					})), r.range = u, Array.from(s.querySelectorAll("textarea")).reverse()))
					if ((0, Z.Z)(e) && !e.closest("tracking-block")) {
						r.insert(e);
						break
			...
			let nJ = (0, W.D)(async e => {
				...
				if (t && !t.ok && (0, v.v)(), t && 200 === t.status) {
					...
					if (e && i && a) {
						let t = (0, $.r)(document, e.reactions_container.trim()),
							n = (0, $.r)(document, e.comment_header_reaction_button.trim());
			...
			function nQ(e) {
				...
				e.preventDefault(), nJ(e)
			}), (0, w.on)("toggle", ".js-reaction-popover-container", function(e) {
				let t = e.currentTarget.hasAttribute("open");
				for (let n of e.target.querySelectorAll(".js-reaction-option-item")) t ? (n.addEventListener("mouseenter", nY), n.addEventListener("mouseleave", nQ)) : (n.removeEventListener("mouseenter", nY), n.removeEventListener("mouseleave", nQ))
			}, {
				capture: !0
			});
			var n0 = n(5582);
			if ((0, w.on)("click", "form button:not([type]), form button[type=submit], form input[type=submit]", function(e) {
					...
					let t = (0, n0.u)(e);
					t && t.remove()
				}), (0, S.rK)(t_.Z), (0, w.on)("click", ".js-remote-submit-button", async function(e) {
					let t;
					let n = e.currentTarget,
						r = n.form;
					e.preventDefault();
			...
			let n1 = new WeakMap;
			(0, w.on)("click", ".js-markdown-link-button", async function({
				currentTarget: e
			}) {
				let t = document.querySelector(".js-markdown-link-dialog"),
				...
				e instanceof HTMLElement && n1.set(r, e.closest("markdown-toolbar").field.selectionEnd)
			}), (0, w.on)("click", ".js-markdown-link-insert", ({
				currentTarget: e
			}) => {
				let t = e.closest("details-dialog"),
					n = document.querySelector(`#${e.getAttribute("data-for-textarea")}`),
					r = n1.get(t) || 0,
					i = t.querySelector("#js-dialog-link-href").value,
					a = t.querySelector("#js-dialog-link-text").value,
					o = `[${a}](${i}) `,
					s = n.value.slice(0, r),
					l = n.value.slice(r);
				n.value = s + o + l, n.focus(), n.selectionStart = n.selectionEnd = r + o.length
			}), n(55240);
			var n7 = n(28585);
			(0, w.on)("click", ".js-saved-reply-menu.ActionListWrap", function(e) {
				...
				(0, eL.Om)(i, n), e.target.closest("modal-dialog")?.close(), setTimeout(() => i.focus(), 0)
			}, {
				capture: !0
			...
			function n5(e, t, n, r) {
				let i = (0, n4.M9)(e, e => t.querySelector(`#LC${e}`));
				if (!i) return;
				if (n) {
				...
				a.classList.add(...["text-bold", "hx_keyword-hl", "rounded-2", "d-inline-block"]), (0, n2.v)(i, a)
			...
			function rn(e, t) {
				...
				(0, S.AC)(".js-notification-shelf .js-notification-action form", async function(e, t) {
					...
					if (n) {
						...
						e && e.click();
						return
					}(0, n6.a)(e, e), await n8(t)
				})
			})(), re(), document.addEventListener(ti.QE.SUCCESS, re), document.addEventListener("turbo:before-fetch-request", function(e) {
				let t = (0, n3.I)(e.detail.url.pathname);
				if (t) {
			...
			}), document.addEventListener(ti.QE.SUCCESS, rt), rt(), (0, B.w4)("keyup", ".js-site-search-field", function(e) {
				let t = e.target,
					n = 0 === t.value.length;
				n && "Backspace" === e.key && t.classList.contains("is-clearable") && rn(t, !1), n && "Escape" === e.key && rn(t, !0), t.classList.toggle("is-clearable", n)
				...
				t.classList.add("focus"), e.addEventListener("blur", function n() {
					t.classList.remove("focus"), 0 === e.value.length && e.classList.contains("js-site-search-field") && rn(e, !0), e.removeEventListener("blur", n)
				})
			...
			let rr = new ResizeObserver(e => {
				for (let {
					...
					(t.classList.contains("sm-search-input") || e) && function(e, t) {
						window.innerWidth < 768 ? t ? (0, t5.Tz)(e) : (0, t5.N9)(e) : window.innerWidth >= 768 && (t ? (0, t5.N9)(e) : (0, t5.Tz)(e))
					}(t, e)
				}
			});
			...
			let ro = new WeakMap,
				rs = document.querySelector("#snippet-clipboard-copy-button"),
				rl = document.querySelector("#snippet-clipboard-copy-button-unpositioned");
			...
			function ru(e, t, n) {
				rd(e, t), n && e.classList.toggle("on");
			...
			function rd(e, t) {
				...
				try {
					n = await t.json(), r && (await ru(r, n.json.count, i), function(e) {
						let t;
					...
					if (t.response?.status === 409 && t.response.json.confirmationDialog) {
						...
						if (a instanceof HTMLTemplateElement && o) {
							...
							s.addEventListener("social-confirmation-form:success", async e => {
								e instanceof CustomEvent && r && await ru(r, e.detail.count, i)
			...
			L.n4?.addEventListener("visibilitychange", () => {
				let e = L.n4?.hidden || !1;
				void 0 !== u && clearTimeout(u), u = setTimeout(() => {
					if (e !== rp)
						for (let t of (rp = e, u = void 0, rh)) t(rp)
				}, e ? 3e4 : 0)
			}), async function() {
				let e = await (0, rm.G)();
				if (!e) return;
				let t = (0, O.g)(t => e.subscribe(t.flat())),
					n = (0, O.g)(t => e.unsubscribeAll(...t)),
					r = (0, O.g)(t => e.updatePresenceMetadata(t));
				(0, T.N7)(".js-socket-channel[data-channel]", {
					subscribe: e => {
						var n;
						let i = (function(e) {
								let t = (e.getAttribute("data-channel") || "").trim().split(/\s+/);
								return t.map(rf.Topic.parse).filter(rg)
							})(e).map(t => ({
								subscriber: e,
								topic: t
							})),
							a = i.map(e => e.topic.name).filter(e => (0, rf.A)(e)),
							o = {
								unsubscribe() {}
							};
						if (a.length) {
							...
							o = (0, F.qC)((0, F.RB)(e, "socket:set-presence-metadata", e => {
								...
								t = e, s()
							})(rp), rh.push(n), new F.w0(() => {
								let e = rh.indexOf(n); - 1 !== e && rh.splice(e, 1)
							})))
						}
						return t(i), o
					},
			...
			if ("function" == typeof BroadcastChannel) try {
				(ry = new BroadcastChannel("stale-session")).onmessage = e => {
					"string" == typeof e.data && rb(e.data)
				}
			} catch {}
			if (!ry) {
				let e = !1;
				ry = {
					...
					if (!e && t.storageArea === window.localStorage && "logged-in" === t.key) try {
						("SIGNED_IN" === t.newValue || "SIGNED_OUT" === t.newValue || t.newValue?.startsWith("SWITCHED")) && rb(t.newValue)
					} finally {
						window.localStorage.removeItem(t.key)
					}
				})
			}
			let rv = document.querySelector(".js-stale-session-flash[data-signedin]");
			if (rv) {
				let e = rv.getAttribute("data-signedin") || "";
				ry?.postMessage(e)
			}
			let rw = () => {
				ry?.postMessage("false")
			};
			...
			async function rE(e) {
				...
				try {
					await (0, t_.Z)(), t = await (0, td.a_)(document, s)
				} catch (e) {
					a.classList.add("d-none"), o.classList.remove("d-none")
				}
				t && (i.replaceWith(t), r.querySelector(".js-details-container").classList.add("open"), n && r.classList.contains("js-append-menu-to-body") && rS(document.body, r, n))
			}
			...
			function rL(e) {
				...
				n && (t.addEventListener("toggle", r), n.classList.contains("js-close-menu-on-scroll") && window.addEventListener("scroll", i, {
					capture: !0
				}), n.classList.remove("d-none"), n.querySelector(".js-details-container").classList.add("open"), n.classList.contains("js-append-menu-to-body") && (document.body.appendChild(n), rS(document.body, n, t)))
			}, {
				capture: !0
				...
				add(e) {
					e.addEventListener("mouseenter", rL, {
						once: !0
					})
				},
				remove(e) {
					e.removeEventListener("mouseenter", rL)
				}
			}), n(80860);
			var rj = n(31287);
			async function rA(e) {
			...
			async function rC(e, t) {
				let [n, r] = await rx(e), i = (function(e, t) {
			...
			async function rM(e) {
				let t = await (0, td.a_)(document, e),
					n = t.firstElementChild;
				return [n, [...n.children]]
			}(0, w.on)("click", "button[data-sudo-required], summary[data-sudo-required]", rA), (0, T.N7)("form[data-sudo-required]", {
				constructor: HTMLFormElement,
				subscribe: e => (0, F.RB)(e, "submit", rA)
			}), (0, T.N7)("text-expander[data-emoji-url]", {
				subscribe: e => (0, F.qC)((0, F.RB)(e, "text-expander-change", rq), (0, F.RB)(e, "text-expander-value", rT), (0, F.RB)(e, "text-expander-activate", rk))
			});
			let rx = (0, eZ.Z)(rM);
			var r_ = n(45974);
    ...
    <ul
      ...
      data-query="${r}"
    >
      ${e.map(e=>{let t=e.type in n?(0,$.r)(document,n[e.type]):"";return(0,r_.dy)`
      <li class="markdown-title" role="option" id="suggester-issue-${e.id}" data-value="${e.number}">
        <span class="d-inline-block mr-1">${t}</span>
        <small>#${e.number}</small> ${(0,r_.Au)(e.title)}
      </li>
    `})}
    </ul>
  `, t)
			...
			function rD(e) {
				...
				0 > ["ArrowRight", "ArrowLeft"].indexOf(t) || r$(e.target)
			}
			async function rO(e, t, n) {
				let r = await rF(e, t, n),
					i = document.createElement("div");
				rN(r.matches, i, r.icons, t);
				...
				subscribe: e => {
					let t = [(0, F.RB)(e, "text-expander-change", rP), (0, F.RB)(e, "text-expander-value", rH), (0, F.RB)(e, "keydown", rD), (0, F.RB)(e, "click", rI)];
					return (0, F.qC)(...t)
				}
			});
			let rB = new Set,
			...
			async function rF(e, t, n) {
				...
				let a = t.slice(0, 3);
				(0, nv.c)("REPOSITORY_SUGGESTER_ELASTIC_SEARCH") && Number.isFinite(Number(t)) && (a = t);
				let o = rW.get(a);
				if (o) return rR(o, t);
				if (!rB.has(a)) {
					rB.add(a);
			...
			async function rU(e, t, n) {
				...
				let i = await rz(r.toString());
				if (rW.set(t, i), rB.delete(t), rW.size > 5) {
					let e = rW.size - 5,
						t = Array.from(rW.keys()).slice(0, e);
					for (let e of t) rW.delete(e)
				}
			...
			async function rZ(e, t) {
				...
				n = o, r = a, (0, r_.sY)((0, r_.dy)`
    <ul role="listbox" class="suggester-container suggester suggestions list-style-none position-absolute">
      ${n.map(e=>{let t="user"===e.type?e.login:e.name,n="user"===e.type?e.name:e.description;return(0,r_.dy)`
  ...
  `, r);
				...
				subscribe: e => (0, F.qC)((0, F.RB)(e, "text-expander-change", rG), (0, F.RB)(e, "text-expander-value", rX))
			});
			let rK = (0, eZ.Z)(async function(e) {
				let t = await self.fetch(e, {
					headers: {
						"X-Requested-With": "XMLHttpRequest",
						Accept: "application/json"
			...
			async function rY(e) {
				...
				try {
					0 === i.total ? i.members.push("This team has no members") : i.total > i.members.length && i.members.push(`${i.total-i.members.length} more`), rQ(o, function(e) {
			...
			function r7(e = !0) {
				...
				if (n) r6(n);
					...
					if (function(e) {
							let t = r2(e, ".js-comment-container");
							return !!t && ((0, nP.$)(t), !0)
						}(t) || r4(t, ".js-thread-hidden-comment-ids") || r4(t, ".js-review-hidden-comment-ids")) return;
			...
			async function r9() {
				return Promise.all([r5(), r3()])
			}
			async function r6(e) {
				await r9(),
					function(e) {
						let t = e.closest("details, .js-details-container");
						t && ("DETAILS" === t.nodeName ? t.setAttribute("open", "open") : (0, e9.jo)(t) || (0, e9.Qp)(t))
					}(e);
				let t = e.querySelector(`[href='#${e.id}']`);
				if ((0, tK.zT)(e), t) {
					let e = t.getAttribute("data-turbo");
					t.setAttribute("data-turbo", "false"), t.click(), null === e ? t.removeAttribute("data-turbo") : t.setAttribute("data-turbo", e)
				}
			}
			async function r8(e, t) {
				...
				try {
					n = await (0, td.a_)(document, i.toString())
				} catch (e) {
					return
				}
			...
			document.addEventListener("keydown", e => {
				...
				t && (0, rJ.uQ)(t, () => {
					window.location.hash = "", (0, I.lO)(window.history.state, "", window.location.pathname + window.location.search)
				})
			}), document.addEventListener("click", e => {
				let t = document.querySelector(".js-targetable-element:target");
				!(!t || e.target instanceof HTMLAnchorElement) && e.target instanceof HTMLElement && (t.contains(e.target) || (0, rJ.uQ)(t, () => {
					window.location.hash = "", (0, I.lO)(window.history.state, "", window.location.pathname + window.location.search)
				}))
			}), n(48804), (0, T.N7)(".js-team-mention", function(e) {
				e.addEventListener("mouseenter", rY)
				...
				r7()
			}), (0, T.N7)(".js-timeline-progressive-focus-container", r1), window.addEventListener("sticky-header-rendered", () => {
				r1()
			...
			var ir = n(67852),
				ii = n(23243),
				ia = n(78923);
			(0, ir.E_)(ia.w), (0, ir.OY)(0), ir.session.isVisitable = () => !0;
			let io = Object.getOwnPropertyDescriptor(ir.cr.prototype, "reloadReason").get;
			...
			Object.defineProperty(ir.cr.prototype, "reloadReason", {
				get() {
					let e = io.call(this);
					if ("tracked_element_mismatch" !== e.reason) return e;
					let t = Object.fromEntries(is(this.currentHeadSnapshot)),
						n = [];
					for (let [e, r] of is(this.newHeadSnapshot)) t[e] !== r && n.push((0, ii.T2)(e));
					return {
			...
			let il = e => {
				...
				history[e] = function(n, r, i) {
					...
					ir.ry.history.update(function(r, i, o) {
			...
			il("replaceState"), il("pushState");
			let ic = ir.session.adapter,
				iu = () => {
					ic.progressBar.setValue(0), ic.progressBar.show()
				},
				id = () => {
					ic.progressBar.setValue(1), ic.progressBar.hide()
				};
			var im = n(78806);
			let ih = new Map,
				ip = new Map,
				ig = () => ih.get(document.location.href),
				ib = (e, t) => ih.set(e, t),
				iy = () => ip.set(document.location.href, (0, ii.Yg)()),
				iv = () => ip.get(document.location.href);
			(async () => {
				await ea.x, ib(document.location.href, (0, ii.ag)(document)), iy()
			})();
			let iw = !1,
				iS = null;
			L.iG && (0, T.N7)("[data-turbo-frame]", {
				...
				if (e.target instanceof HTMLElement && e instanceof CustomEvent) {
					if (im.Z(location.href, e.detail.url)) {
						e.preventDefault();
						return
					}
					e.defaultPrevented || ti.LD("turbo")
				}
			}), L.n4?.addEventListener("turbo:before-fetch-request", function(e) {
				let t = window.onbeforeunload?.(e);
				if (t) {
					let n = confirm(t);
					n ? window.onbeforeunload = null : (e.preventDefault(), id())
				}
			}), L.n4?.addEventListener("turbo:before-fetch-request", e => {
				if (e.defaultPrevented) return;
				let t = e.target;
				ii.HN(t) && iu(), t?.tagName === "HTML" && (e.detail.fetchOptions.headers["Turbo-Visit"] = "true")
			});
			let iE = L.n4?.createElement("turbo-frame"),
				iL = Object.getPrototypeOf(iE.delegate),
				ij = iL.requestErrored;
			iL.requestErrored = function(e, t) {
				...
				if (iw = t.statusCode >= 500, 404 === t.statusCode && (ii.uL(t.statusCode), window.location = t.location, e.preventDefault()), history.replaceState({
						...history.state,
						skipTurbo: !1
					}, "", location.href), iw) {
					let e = await t.responseHTML,
						n = ia.w.createHTML(e, t.response);
					iS = new DOMParser().parseFromString(n, "text/html")
				}
			}), L.n4?.addEventListener("turbo:frame-render", e => {
				ii.HN(e.target) && id()
			}), L.n4?.addEventListener("turbo:before-render", async e => {
				e instanceof CustomEvent && (e.preventDefault(), e.detail.render = iT, await ii.q3(), e.detail.resume(!0), ii.Ap(document.documentElement, e.detail.newBody.ownerDocument.documentElement), iy())
			});
			let iA = () => new Promise(e => {
					setTimeout(() => e(), 0)
				}),
				iT = async (e, t) => {
					if (await iA(), iw && iS) {
						for (let e of (document.documentElement.replaceWith(iS.documentElement), document.querySelectorAll("script"))) {
							let t = (0, ii.lL)(e);
							t && e.replaceWith(t)
						}
						return
					...
					n && r ? ((0, ii.Ap)(e, t), n.replaceWith(r)) : ((0, ii.uL)("missing_turbo_body"), window.location.reload())
				};
			...
			let ik = !1,
				iC = e => {
					...
					return n && t && !(0, ii.AU)(r.pathname, location.pathname) || i && !(0, ii.ck)(r.pathname, location.pathname)
				};
			L.n4?.addEventListener("turbo:frame-click", function(e) {
				if (e.target instanceof HTMLElement && e instanceof CustomEvent) {
					...
					iC(e) && (ii.uL("repo_mismatch"), e.target.removeAttribute("data-turbo-frame"), e.preventDefault()), e.defaultPrevented || ti.LD("turbo.frame")
				}
			}), L.n4?.addEventListener("turbo:before-fetch-response", e => {
				d = e.detail.fetchResponse, ii.HN(e.target) && ib(window.location.href, ii.ag(document))
				...
				if (ik = !0, !d) return;
				let r = await d.responseHTML,
					i = d.location,
					a = ia.w.createHTML(r, d.response),
				...
				let s = e.target,
					...
					u = ii.po(o);
				if (!c || u.length > 0) {
					ii.uL(`tracked_element_mismatch-${u.join("-")}`), window.location = i;
					return
				}
				ib(i.href, ii.ag(o)), ii.DT(o), ii.xk(o), ii.wz(o), iN(s, c), await ii.q3(), t(), iH(n) && window.scrollTo(0, 0), iM(o)
			}), L.iG?.addEventListener("popstate", () => {
				document.addEventListener("turbo:load", () => {
					let e = ig()?.replacedElements || [];
					ii.wz(document, e)
				}, {
					once: !0
				})
			}), L.n4?.addEventListener(ti.QE.SUCCESS, () => {
				ix(), ik && (ik = !1, i_(), iR(), ti.u5())
			});
			let iM = e => {
				...
				iH = e => "true" !== e.getAttribute("data-turbo-skip-scroll") && "advance" === e.getAttribute("data-turbo-action");
			L.n4?.addEventListener("turbo:frame-load", () => {
				ti.sj() && ti.U6("turbo.frame"), ti.TL({
				...
				!ti.sj() || t || ti.OE() ? t && (ti.OE() || ti.sj()) ? ti.r_({
					skipIfGoingToReactApp: !0,
			...
			}), L.n4?.addEventListener("beforeunload", () => ti.FP()), L.n4?.addEventListener("turbo:reload", function(e) {
				e instanceof CustomEvent && ti.Ak(e.detail.reason)
			}), L.n4?.addEventListener(ti.QE.END, iy), L.n4?.addEventListener(ti.QE.PROGRESS_BAR.START, iu), L.n4?.addEventListener(ti.QE.PROGRESS_BAR.END, id), window.requestIdleCallback(() => {
				let e = function() {
			...
			let iz = (p = new WeakMap, (g = class SudoCredentialOptionsElement extends HTMLElement {
				connectedCallback() {
					let e = this.initialState;
					iF(this, p, e), this.reRenderPrompt(!0)
				}
				reRenderPrompt(e = !1) {
					this.resetPrompt();
					try {
				...
				handleUnexpectedPromptError(e) {
					...
					if (e && "password" !== iW(this, p)) throw this.renderPasswordOptionWithError(t), e
				}
				...
				reRenderNavContainer() {
					this.isWebAuthnAvailable() && "webauthn" !== iW(this, p) && this.safeSetElementVisibility(this.webauthnNav, !0), this.isGitHubMobileAvailable() && "github_mobile" !== iW(this, p) && this.safeSetElementVisibility(this.githubMobileNav, !0), this.isTotpAppAvailable() && "app" !== iW(this, p) && this.safeSetElementVisibility(this.totpAppNav, !0), this.isTotpSmsAvailable() && "sms" !== iW(this, p) && this.safeSetElementVisibility(this.totpSmsNav, !0), "password" !== iW(this, p) && this.safeSetElementVisibility(this.passwordNav, !0)
				}
				renderWebauthnOption() {
					this.safeSetElementVisibility(this.webauthnContainer, !0), this.webauthnGet?.setState(iD.Zh() ? i$.State.Ready : i$.State.Unsupported)
				}
				...
				showWebauthn() {
					iF(this, p, "webauthn"), this.reRenderPrompt()
				}
				showGitHubMobile() {
					iF(this, p, "github_mobile"), this.reRenderPrompt()
				}
				showTotpApp() {
					iF(this, p, "app"), this.reRenderPrompt()
				}
				showTotpSms() {
					iF(this, p, "sms"), this.reRenderPrompt()
				}
				showPassword() {
					iF(this, p, "password"), this.reRenderPrompt()
				}
				githubMobileRetry(e) {
				...
				async initiateGitHubMobileAuthRequest() {
					...
					try {
						...
						if (!t.ok && "github_mobile" === iW(this, p)) {
						...
						(0, iI.Hu)(a, () => this.mobileApprovedHandler(), e => this.mobileFailHandler(e), () => this.mobileCancelCheck())
					} catch (e) {
						"github_mobile" === iW(this, p) && this.mobileFailHandler(this.githubMobileGenericErrorMessage)
					} finally {
						"github_mobile" === iW(this, p) && (this.safeSetElementVisibility(this.githubMobileLoading, !1), this.safeSetElementVisibility(this.githubMobileContainer, !0))
					}
				}
				async resendTotpSms() {
					this.hideErrorMessage(), (0, iO.C)();
					try {
				...
				async initiateTotpSmsRequest(e = !1) {
					...
					try {
						...
						if (n.ok || "sms" !== iW(this, p)) "sms" === iW(this, p) && e && (0, iO.v)();
						else {
							let e = await n.json();
							this.showErrorMessage(e.error)
						}
					} catch (e) {
						"sms" === iW(this, p) && this.showErrorMessage(this.smsGenericErrorMessage)
					}
					"sms" === iW(this, p) && this.safeSetElementVisibility(this.totpSmsResendNav, !0)
				}
				mobileApprovedHandler() {
					if ("github_mobile" === iW(this, p)) {
						let e = this.githubMobileContainer.getElementsByTagName("form")[0];
						(0, P.Bt)(e)
					}
				}
				mobileFailHandler(e) {
					"github_mobile" === iW(this, p) && (this.showErrorMessage(e), (0, iI.cj)())
				}
				mobileCancelCheck() {
					return "github_mobile" !== iW(this, p)
				}
			...
			iU([iP.Lj], iz.prototype, "initialState", void 0), iU([iP.Lj], iz.prototype, "webauthnAvailable", void 0), iU([iP.Lj], iz.prototype, "githubMobileAvailable", void 0), iU([iP.Lj], iz.prototype, "totpAppAvailable", void 0), iU([iP.Lj], iz.prototype, "totpSmsAvailable", void 0), iU([iP.Lj], iz.prototype, "githubMobilePromptUrl", void 0), iU([iP.Lj], iz.prototype, "githubMobileGenericErrorMessage", void 0), iU([iP.Lj], iz.prototype, "smsGenericErrorMessage", void 0), iU([iP.Lj], iz.prototype, "genericErrorMessage", void 0), iU([iP.Lj], iz.prototype, "totpSmsTriggerUrl", void 0), iU([iP.fA], iz.prototype, "flashErrorMessageContainer", void 0), iU([iP.fA], iz.prototype, "flashErrorMessageText", void 0), iU([iP.fA], iz.prototype, "webauthnContainer", void 0), iU([iP.fA], iz.prototype, "githubMobileContainer", void 0), iU([iP.fA], iz.prototype, "githubMobileLoading", void 0), iU([iP.fA], iz.prototype, "githubMobileLanding", void 0), iU([iP.fA], iz.prototype, "totpAppContainer", void 0), iU([iP.fA], iz.prototype, "totpSmsContainer", void 0), iU([iP.fA], iz.prototype, "totpSmsLanding", void 0), iU([iP.fA], iz.prototype, "passwordContainer", void 0), iU([iP.fA], iz.prototype, "githubMobileNoChallengeMessage", void 0), iU([iP.fA], iz.prototype, "githubMobileChallengeMessage", void 0), iU([iP.fA], iz.prototype, "githubMobileChallengeValue", void 0), iU([iP.fA], iz.prototype, "webauthnNav", void 0), iU([iP.fA], iz.prototype, "githubMobileNav", void 0), iU([iP.fA], iz.prototype, "totpAppNav", void 0), iU([iP.fA], iz.prototype, "totpSmsNav", void 0), iU([iP.fA], iz.prototype, "totpSmsResendNav", void 0), iU([iP.fA], iz.prototype, "passwordNav", void 0), iU([iP.fA], iz.prototype, "webauthnGet", void 0), iU([iP.fA], iz.prototype, "loginField", void 0), iU([iP.fA], iz.prototype, "passwordField", void 0), iz = iU([iP.Ih], iz);
			let iV = 0,
				iX = "IntersectionObserver" in window ? new IntersectionObserver(function(e) {
					for (let t of e) t.isIntersecting && iG(t.target)
				}, {
					root: null,
					rootMargin: "0px",
					threshold: 1
			...
			function iG(e) {
				...
				remove(e) {
					iV--, iX && iX.unobserve(e), 0 === iV && function() {
				...
				subscribe: e => (0, F.RB)(e, "socket:message", function(e) {
					...
					if (t.getAttribute("data-channel-target") === n.gid)
						for (let e of document.querySelectorAll(".js-unread-item")) iG(e)
				})
			});
			let iZ = 0,
				iK = /^\(\d+\)\s+/;
			...
			function iJ() {
				let e = iZ ? `(${iZ}) ` : "";
				document.title.match(iK) ? document.title = document.title.replace(iK, e) : document.title = `${e}${document.title}`
			}
			async function iY() {
			...
			function i0() {
				if (!(0, iQ.l)() || document.querySelector(":target")) return;
				let e = (0, ra.$z)(location.hash),
					t = e.startsWith("user-content-") ? e : `user-content-${e}`,
					n = (0, ra.Q)(document, t) ?? (0, ra.Q)(document, t.toLowerCase());
				n && (0, tK.zT)(n)
			}
			async function i1() {
				await n.e("app_assets_modules_github_user-status-submit_ts").then(n.bind(n, 47455))
			}
			window.addEventListener("hashchange", i0), document.addEventListener("turbo:load", i0), async function() {
				await ea.x, i0()
			...
			async function i5(e, t, n) {
				...
				if (i.ok) {
					let e = await i.json();
					for (let t in e) a.set(t, (0, $.r)(document, e[t]))
				}
				return a
			}
			async function i3() {
			...
			function ar(e, t) {
			...
			}), (0, B.q6)(".js-user-list-form input", i2), (0, B.q6)(".js-user-list-form textarea", i2), (0, w.on)("auto-check-error", ".js-user-list-form input", function(e) {
				...
				n.json.didCreate ? await i3() : r && await (0, ey.x0)(r), (0, w.f)(e, "user-list-menu-form:success")
				...
				add(e) {
					e.addEventListener("input", i9), e.addEventListener("change", i9), e.addEventListener("submit", i6);
					let t = e.closest("details-dialog");
					t && (t.closest("details").addEventListener("toggle", i8), t.addEventListener("details-dialog-close", ae))
				},
				remove(e) {
					e.removeEventListener("input", i9), e.removeEventListener("change", i9), e.removeEventListener("submit", i6);
					let t = e.closest("details-dialog");
					t && (t.closest("details").removeEventListener("toggle", i8), t.removeEventListener("details-dialog-close", ae), i6())
				}
			}), (0, T.N7)(".will-transition-once", {
				constructor: HTMLElement,
				subscribe: e => (0, F.RB)(e, "transitionend", at)
			}), (0, T.N7)(".js-issue-link", {
				subscribe: e => (0, F.RB)(e, "mouseenter", an)
			});
			var ai = n(12085),
				aa = n.n(ai);
			...
			function au(e, t) {
				ac(".js-label-name-error", e, t.name), ac(".js-label-description-error", e, t.description), ac(".js-label-color-error", e, t.color)
			}

			function ad(e) {
				ac(".js-label-name-error", e, null), ac(".js-label-description-error", e, null), ac(".js-label-color-error", e, null)
			}
			async function am(e) {
				let t;
				...
				try {
					t = await (0, td.a_)(document, d)
				} catch (t) {
					let e = await t.response.json();
					au(r, e), i && (i.textContent = e.message, i.hidden = !1);
					return
				}
				i && (i.textContent = "", i.hidden = !0), ad(r), o.textContent = "", o.appendChild(t), n.setAttribute("data-last-preview-url", d)
			}
			...
			async function ap(e) {
				...
				as(i, aa().hex.rgb(r)), (0, ec.Qc)(t), am(n);
				...
				e.reset(), ad(e), document.querySelector(".js-label-list").prepend(n.html), ah(1), af(e, !1);
				let r = e.querySelector(".js-new-label-color"),
					i = ao();
				al(r, i), am(e.querySelector(".js-new-label-name-input")), (0, ec.Qc)(e);
				let a = e.closest(".js-details-container");
				a instanceof HTMLElement && (0, e9.Qp)(a)
			...
			function ay(e, t, n, r) {
				...
				if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) o = Reflect.decorate(e, t, n, r);
					...
					for (var s = e.length - 1; s >= 0; s--)(i = e[s]) && (o = (a < 3 ? i(o) : a > 3 ? i(t, n, o) : i(t, n)) || o);
				return a > 3 && o && Object.defineProperty(t, n, o), o
			}(0, w.on)("suggester:complete", ".js-new-label-name-input", ag), (0, B.q6)(".js-new-label-name-input", ag), (0, B.q6)(".js-new-label-description-input", ag), (0, B.q6)(".js-new-label-color-input", ag), (0, B.w4)("keypress", ".js-new-label-name-input", function(e) {
				let t = e.target,
				...
				capture: !0
			}), (0, w.on)("change", ".js-thread-notification-setting", ab), (0, w.on)("change", ".js-custom-thread-notification-option", ab), (0, w.on)("reset", ".js-custom-thread-settings-form", ab);
			let av = class CollapsibleSidebarWidgetElement extends HTMLElement {
				get activeClass() {
			...
			ay([iP.fA], av.prototype, "collapsible", void 0), av = ay([iP.Ih], av);
			let aS = ((y = class SidebarMemexInputElement extends HTMLElement {
				get isDisabled() {
			...
			aw([iP.Lj], aS.prototype, "updateUrl", void 0), aw([iP.Lj], aS.prototype, "csrfToken", void 0), aw([iP.Lj], aS.prototype, "instrumentType", void 0), aw([iP.Lj], aS.prototype, "columnId", void 0), aw([iP.GO], aS.prototype, "inputs", void 0), aw([iP.fA], aS.prototype, "read", void 0), aw([iP.fA], aS.prototype, "write", void 0), aw([iP.GO], aS.prototype, "parameters", void 0), aS = aw([iP.Ih], aS);
			var aE = n(98973);
			...
			function aL(e, t = !1) {
				(t || ! function(e) {
					...
					let n = [...document.querySelectorAll(".js-reviewer-team")].map(e => e.getAttribute("data-id")),
						r = e instanceof HTMLFormElement ? new FormData(e) : aR(e),
					...
					return a_(e, `${t}?${o}`), !0
				}(e)) && (e instanceof HTMLFormElement ? (0, P.Bt)(e) : aM(e))
			}
			...
			function aA(e, t) {
				...
				if (t.hasAttribute("data-clear-assignees")) {
					...
					aL(r)
				} else i ? n.closest("details").addEventListener("toggle", aj, {
					once: !0
				}) : aL(r)
			}, {
				capture: !0
				...
				try {
					let n = await t.html(),
						...
						a = r?.parentElement;
					r.replaceWith(n.html), a && i && aA(a, i)
				} catch (e) {
			...
			async function aq(e, t) {
				...
				try {
					for (let t of (await ax(e), a)) t.remove()
				} catch (e) {
					aT.delete(n)
				}
			}
			...
			function aR(e) {
				...
				add(e) {
					...
					aq(e, t), window.addEventListener("pagehide", () => aC(e, t)), window.addEventListener("turbo:before-visit", () => aC(e, t)), window.addEventListener("submit", e => {
						e.defaultPrevented || (ak = !0, setTimeout(() => {
							for (let e of Object.keys(sessionStorage)) - 1 !== e.indexOf(t) && (sessionStorage.removeItem(e), aT.clear())
						}, 0))
					}, {
						capture: !0
					})
			...
			}), (0, ti.cY)(), (0, nv.c)("NAVIGATION_INTERCEPTS") && (0, ti.RN)()
		},
		47442: (e, t, n) => {
			"use strict";
			n.d(t, {
			...
			let o = class TagInput {
				setup() {
					this.container.addEventListener("click", e => {
						...
						"Enter" !== e.key || e.defaultPrevented || !this.input.value || (e.preventDefault(), this.selectTag(this.input.value), this.autoComplete.open = !1)
		...
		59840: (e, t, n) => {
			...
			let c = ((r = class WebauthnGetElement extends HTMLElement {
				...
				handleWebauthnSubtle() {
					...
					e && (e.hidden = !1, e.addEventListener("webauthn-subtle-submit", () => {
