...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["vendors-node_modules_github_turbo_dist_turbo_es2017-esm_js"], {
		67852: (e, t, s) => {
			...
			let a = null !== (x = null === (W = globalThis.trustedTypes) || void 0 === W ? void 0 : W.emptyHTML) && void 0 !== x ? x : "";
			! function(e) {
				e.eager = "eager", e.lazy = "lazy"
			}(U || (U = {}));
			let FrameElement = class FrameElement extends HTMLElement {
				constructor() {
					super(), this.loaded = Promise.resolve(), this.previousSrc = null, this.delegate = new FrameElement.delegateConstructor(this)
				}
			...
			function c(e, t) {
				let s = (null == t ? void 0 : t.getAttribute("formaction")) || e.getAttribute("action") || e.action;
				return l(s)
			}
			...
			function m(e) {
				if ("false" == e.getAttribute("data-turbo-eval")) return e;
				{
					let t = document.createElement("script"),
						s = L("csp-nonce");
					return s && (t.nonce = s), null !== e.textContent && (null !== n ? t.textContent = n.createScript(e.textContent) : t.textContent = e.textContent), t.async = !1,
						function(e, t) {
							for (let {
									name: s,
									value: i
			...
			function v(e, ...t) {
				let s = e.reduce((e, s, i) => {
						let r = void 0 == t[i] ? "" : t[i];
						return e + s + r
					}, "").replace(/^\n/, "").split("\n"),
					i = s[0].match(/^\s+/),
					r = i ? i[0].length : 0;
			...
			function w(...e) {
				for (let t of e) "turbo-frame" == t.localName && t.setAttribute("busy", ""), t.setAttribute("aria-busy", "true")
			}

			function E(...e) {
				for (let t of e) "turbo-frame" == t.localName && t.removeAttribute("busy"), t.removeAttribute("aria-busy")
			}
			...
			let FetchRequest = class FetchRequest {
				constructor(e, t, s, i = new URLSearchParams, r = null) {
					this.abortController = new AbortController, this.resolveRequestPromise = e => {}, this.delegate = e, this.method = t, this.headers = this.defaultHeaders, this.body = i, this.url = s, this.target = r
				}
				get location() {
					return this.url
				}
				...
				async perform() {
					...
					null === (t = (e = this.delegate).prepareHeadersForRequest) || void 0 === t || t.call(e, this.headers, this), await this.allowRequestToBeIntercepted(s);
					try {
				...
				async receive(e) {
					let t = new FetchResponse(e),
						s = p("turbo:before-fetch-response", {
							cancelable: !0,
							detail: {
								fetchResponse: t
							},
					...
					return s.defaultPrevented ? this.delegate.requestPreventedHandlingResponse(this, t) : t.succeeded ? this.delegate.requestSucceededWithResponse(this, t) : this.delegate.requestFailedWithResponse(this, t), t
				}
				get fetchOptions() {
					var e;
					return {
				...
				willDelegateErrorHandling(e) {
					let t = p("turbo:fetch-request-error", {
						target: this.target,
						cancelable: !0,
						detail: {
							request: this,
				...
				constructor(e) {
					this.fragment = function(e) {
						for (let t of e.querySelectorAll("turbo-stream")) {
							...
							for (let t of e.templateElement.content.querySelectorAll("script")) "application/json" !== t.type && t.replaceWith(m(t));
							t.replaceWith(e)
						}
						return e
					}(e)
			...
			let FormSubmission = class FormSubmission {
				constructor(e, t, s, i = !1) {
					this.state = _.initialized, this.delegate = e, this.formElement = t, this.submitter = s, this.formData = function(e, t) {
						...
						e.search = s.toString()
					}(this.location, [...this.body.entries()]), this.fetchRequest = new FetchRequest(this, this.method, this.location, this.body, this.formElement), this.mustRedirect = i
				}
				...
				get method() {
					var e;
					let t = (null === (e = this.submitter) || void 0 === e ? void 0 : e.getAttribute("formmethod")) || this.formElement.getAttribute("method") || "";
					return function(e) {
				...
				get action() {
					var e;
					let t = "string" == typeof this.formElement.action ? this.formElement.action : null;
				...
				get stringFormData() {
					return [...this.formData].reduce((e, [t, s]) => e.concat("string" == typeof s ? [
						[t, s]
					] : []), [])
				}
				async start() {
					let {
						initialized: e,
						requesting: t
					} = _, s = S("data-turbo-confirm", this.submitter, this.formElement);
					if ("string" == typeof s) {
						let e = await FormSubmission.confirmMethod(s, this.formElement, this.submitter);
						if (!e) return
					}
				...
				requestAcceptsTurboStreamResponse(e) {
					return !e.isIdempotent || function(e, ...t) {
			...
			let Snapshot = class Snapshot {
				...
				getPermanentElementMapForSnapshot(e) {
					...
					for (let s of this.permanentElements) {
						let {
							id: i
						} = s, r = e.getPermanentElementById(i);
						r && (t[i] = [s, r])
					}
					return t
				}
				...
				constructor(e, t) {
					this.started = !1, this.submitCaptured = () => {
						...
						if (!e.defaultPrevented) {
							...
							t && function(e, t) {
								let s = (null == t ? void 0 : t.getAttribute("formmethod")) || e.getAttribute("method");
								return "dialog" != s
							}(t, s) && function(e, t) {
								let s = (null == t ? void 0 : t.getAttribute("formtarget")) || e.target;
				...
				async render(e) {
					...
					if (s) try {
						...
						let s = new Promise(e => this.resolveInterceptionPromise = e),
							...
							n = this.delegate.allowsImmediateRender(i, r);
						n || await s, await this.renderSnapshot(e), this.delegate.viewRenderedSnapshot(i, t), this.delegate.preloadOnLoadLinksForView(this.element), this.finishRenderingSnapshot(e)
					} finally {
			...
			let FormLinkClickObserver = class FormLinkClickObserver {
				...
				followedLinkToLocation(e, t) {
					...
					let l = e.hasAttribute("data-turbo-stream");
					l && i.setAttribute("data-turbo-stream", ""), this.delegate.submittedFormLinkToLocation(e, t, i), document.body.appendChild(i), i.addEventListener("turbo:submit-end", () => i.remove(), {
						once: !0
			...
			let Renderer = class Renderer {
				constructor(e, t, s, i, r = !0) {
					this.activeElement = null, this.currentSnapshot = e, this.newSnapshot = t, this.isPreview = i, this.willRender = r, this.renderElement = s, this.promise = new Promise((e, t) => this.resolvingFunctions = {
						resolve: e,
						reject: t
					})
				}
			...
			let FrameRenderer = class FrameRenderer extends Renderer {
				...
				static renderElement(e, t) {
					...
					let r = null === (s = t.ownerDocument) || void 0 === s ? void 0 : s.createRange();
				...
				async render() {
					await g(), this.preservingPermanentElements(() => {
						this.loadFrameElement()
					}), this.scrollFrameIntoView(), await g(), this.focusFirstAutofocusableElement(), await g(), this.activateScriptElements(), this.activateImageElements()
				}
				loadFrameElement() {
				...
				scrollFrameIntoView() {
					if (this.currentElement.autoscroll || this.newElement.autoscroll) {
						...
						let s = this.currentElement.firstElementChild,
							i = "end" == (e = this.currentElement.getAttribute("data-autoscroll-block")) || "start" == e || "center" == e || "nearest" == e ? e : "end",
							r = "auto" == (t = this.currentElement.getAttribute("data-autoscroll-behavior")) || "smooth" == t ? t : "auto";
							...
							if ("false" == e.getAttribute("data-turbo-eval")) return e;
							{
								...
								return function(e, t) {
									for (let {
										...
										of t.attributes) e.setAttribute(s, i)
								}(t, e), t
							}
						}(e);
						e.replaceWith(t)
    ...
    `
			...
			let HeadSnapshot = class HeadSnapshot extends Snapshot {
				...
				get provisionalElements() {
					return Object.keys(this.detailsByOuterHTML).reduce((e, t) => {
						...
						return null != s || i ? r.length > 1 ? [...e, ...r.slice(1)] : e : [...e, ...r]
					}, [])
				}
				getMetaValue(e) {
			...
			let PageSnapshot = class PageSnapshot extends Snapshot {
				...
				clone() {
					...
					for (let t of e.querySelectorAll('input[type="password"]')) t.value = "";
				...
				get rootLocation() {
					var e;
					let t = null !== (e = this.getSetting("root")) && void 0 !== e ? e : "/";
					return l(t)
				}
			...
			let Visit = class Visit {
				...
				changeHistory() {
					...
					if (!this.historyChanged && this.updateHistory) {
						let t = this.location.href === (null === (e = this.referrer) || void 0 === e ? void 0 : e.href) ? "replace" : this.action,
							s = y(t);
			...
			let BrowserAdapter = class BrowserAdapter {
				constructor(e) {
					this.progressBar = new ProgressBar, this.showProgressBar = () => {
			...
			let CacheObserver = class CacheObserver {
				constructor() {
					this.started = !1, this.removeStaleElements = e => {
						let t = [...document.querySelectorAll('[data-turbo-cache="false"]')];
			...
			let FrameRedirector = class FrameRedirector {
				...
				frameAllowsVisitingLocation(e, {
					href: t
				}, s) {
					let i = p("turbo:frame-click", {
						target: e,
						detail: {
							url: t,
							originalEvent: s
				...
				shouldRedirect(e, t) {
					let s = e instanceof HTMLFormElement ? this.session.submissionIsNavigatable(e, t) : this.session.elementIsNavigatable(e);
					if (!s) return !1;
					{
						let s = this.findFrameElement(e, t);
				...
				findFrameElement(e, t) {
					let s = (null == t ? void 0 : t.getAttribute("data-turbo-frame")) || e.getAttribute("data-turbo-frame");
					if (s && "_top" != s) {
			...
			let History = class History {
				constructor(e) {
					this.restorationIdentifier = b(), this.restorationData = {}, this.started = !1, this.pageLoaded = !1, this.onPopState = e => {
					...
					if (e == this.formSubmission) {
						...
						if (s) {
							...
							let {
								...
								redirected: n,
								response: o
							} = t, a = this.getActionForFormSubmission(e), l = t.location;
							n && "" === t.location.hash && (l.hash = e.fetchRequest.location.hash), this.proposeVisit(l, {
								action: a,
			...
			let PageObserver = class PageObserver {
				constructor(e) {
					this.stage = Q.initial, this.started = !1, this.interpretReadyState = () => {
						let {
							readyState: e
						} = this;
			...
			let StreamObserver = class StreamObserver {
				constructor(e) {
					this.sources = new Set, this.started = !1, this.inspectFetchResponse = e => {
						let t = function(e) {
							var t;
							let s = null === (t = e.detail) || void 0 === t ? void 0 : t.fetchResponse;
							if (s instanceof FetchResponse) return s
						}(e);
						t && function(e) {
							var t;
							let s = null !== (t = e.contentType) && void 0 !== t ? t : "";
							return s.startsWith(StreamMessage.contentType)
			...
			let PageRenderer = class PageRenderer extends Renderer {
				...
				async copyNewHeadStylesheetElements() {
					let e = [];
					for (let t of this.newHeadStylesheetElements) e.push(function(e, t = 2e3) {
				...
				copyNewHeadScriptElements() {
					for (let e of this.newHeadScriptElements) document.head.appendChild(m(e))
				}
			...
			let PageView = class PageView extends View {
				constructor() {
					super(...arguments), this.snapshotCache = new SnapshotCache(10), this.lastRenderedLocation = new URL(location.href), this.forceReloaded = !1
				}
				renderPage(e, t = !1, s = !0, i) {
					let r = new PageRenderer(this.snapshot, e, PageRenderer.renderElement, t, s);
					return r.shouldRender ? null == i || i.changeHistory() : this.forceReloaded = !0, this.render(r)
				}
				renderError(e, t) {
					null == t || t.changeHistory();
					let s = new ErrorRenderer(this.snapshot, e, ErrorRenderer.renderElement, !1);
			...
			let Session = class Session {
				...
				allowsImmediateRender({
					...
					let s = this.notifyApplicationBeforeRender(e, t),
						{
							defaultPrevented: i,
							detail: {
								render: r
				...
				applicationAllowsFollowingLinkToLocation(e, t, s) {
					let i = this.notifyApplicationAfterClickingLinkToLocation(e, t, s);
					return !i.defaultPrevented
				}
			...
			var W, x, U, j, _, $, z, K, Y, Q, X = Object.freeze({
				__proto__: null,
				navigator: q,
				session: M,
				cache: H,
			...
			let FrameController = class FrameController {
				constructor(e) {
					this.fetchResponseLoaded = e => {}, this.currentFetchRequest = null, this.resolveVisitPromise = () => {}, this.connected = !1, this.hasBeenLoaded = !1, this.ignoredAttributes = new Set, this.action = null, this.visitCachedSnapshot = ({
						element: e
					}) => {
				...
				async loadSourceURL() {
					this.enabled && this.isActive && !this.complete && this.sourceURL && (this.element.loaded = this.visit(l(this.sourceURL)), this.appearanceObserver.stop(), await this.element.loaded, this.hasBeenLoaded = !0)
				}
						...
						if (t) {
							...
							if (i) {
								let t = new Snapshot(i),
									s = new FrameRenderer(this, this.view.snapshot, t, FrameRenderer.renderElement, !1, !1);
								this.view.renderPromise && await this.view.renderPromise, this.changeHistory(), await this.view.render(s), this.complete = !0, M.frameRendered(e, this.element), M.frameLoaded(this.element), this.fetchResponseLoaded(e)
							} else this.willHandleFrameMissingFromResponse(e) && (console.warn(`A matching frame for #${this.element.id} was missing from the response, transforming into full-page Visit.`), this.visitResponse(e.response))
						}
					} catch (e) {
				...
				allowsImmediateRender({
					...
					let s = p("turbo:before-frame-render", {
							target: this.element,
							detail: Object.assign({
								newFrame: e
							}, t),
				...
				async visit(e) {
					let t = new FetchRequest(this, j.get, e, new URLSearchParams, this.element);
					return this.cancelInFlightNavigation(), this.currentFetchRequest = t, new Promise(e => {
						this.resolveVisitPromise = () => {
				...
				cancelInFlightNavigation(e) {
					this.currentFetchRequest && (this.currentFetchRequest.cancel(), this.currentFetchRequest = null, e && (this.ignoringChangesToAttribute("src", () => {
						e.src = e.previousSrc, E(e)
					}), e.previousSrc && this.ignoringChangesToAttribute("complete", () => {
						e.setAttribute("complete", "")
					})))
				}
				navigateFrame(e, t, s) {
					let i = this.findFrameElement(e, s);
					this.cancelInFlightNavigation(i), this.pageSnapshot = PageSnapshot.fromElement(i).clone(), i.delegate.proposeVisitIfNavigatedWithAction(i, e, s), this.withCurrentNavigationElement(e, () => {
						i.src = t
					})
				}
				proposeVisitIfNavigatedWithAction(e, t, s) {
					if (this.action = function(...e) {
						...
						e.delegate.fetchResponseLoaded = s => {
							if (e.src) {
								let {
									...
									redirected: r,
									response: n
								} = s, o = e.ownerDocument.documentElement.outerHTML, a = {
									response: {
										statusCode: i,
										redirected: r,
										response: n,
								...
								this.action && (a.action = this.action), M.visit(e.src, a)
							}
						}
					}
				}
				...
				findFrameElement(e, t) {
					var s;
					let i = S("data-turbo-frame", t, e) || this.element.getAttribute("target");
					return null !== (s = J(i)) && void 0 !== s ? s : this.element
				}
				async extractForeignFrameElement(e) {
					let t;
					let s = CSS.escape(this.id);
					try {
						if (t = G(e.querySelector(`turbo-frame#${s}`), this.sourceURL)) return t;
						if (t = G(e.querySelector(`turbo-frame[src][recurse~=${s}]`), this.sourceURL)) return await t.loaded, await this.extractForeignFrameElement(t)
					} catch (e) {
				...
				shouldInterceptNavigation(e, t) {
					let s = S("data-turbo-frame", t, e) || this.element.getAttribute("target");
				...
				set complete(e) {
					this.ignoringChangesToAttribute("complete", () => {
						e ? (this.element.setAttribute("complete", ""), this.element.previousSrc = this.element.src) : this.element.removeAttribute("complete")
					})
				}
				get isActive() {
				...
				get rootLocation() {
					var e;
					let t = this.element.ownerDocument.querySelector('meta[name="turbo-root"]'),
						s = null !== (e = null == t ? void 0 : t.content) && void 0 !== e ? e : "/";
					return l(s)
				}
				frameAllowsVisitingLocation(e, {
					href: t
			...
			function G(e, t) {
				if (e) {
					...
					if (null != s && null != t && l(s).href == l(t).href) throw Error(`Matching <turbo-frame id="${e.id}"> element has a source URL which references itself`);
			...
			let StreamElement = class StreamElement extends HTMLElement {
				...
				async render() {
					...
					return null !== (e = this.renderPromise) && void 0 !== e ? e : this.renderPromise = (async () => {
						...
						this.dispatchEvent(e) && (await g(), await e.detail.render(this))
					})()
				}
				disconnect() {
					try {
				...
				get duplicateChildren() {
					var e;
					let t = this.targetElements.flatMap(e => [...e.children]).filter(e => !!e.id),
						s = [...(null === (e = this.templateContent) || void 0 === e ? void 0 : e.children) || []].filter(e => !!e.id).map(e => e.id);
				...
				get targetElementsById() {
					var e;
					let t = null === (e = this.ownerDocument) || void 0 === e ? void 0 : e.getElementById(this.target);
					return null !== t ? [t] : []
				}
				get targetElementsByQuery() {
					var e;
					let t = null === (e = this.ownerDocument) || void 0 === e ? void 0 : e.querySelectorAll(this.targets);
...
//# sourceMappingURL=vendors-node_modules_github_turbo_dist_turbo_es2017-esm_js-c8801a8b58d9.js.map