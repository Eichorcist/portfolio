...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["app_assets_modules_github_behaviors_commenting_edit_ts-app_assets_modules_github_behaviors_ht-83c235"], {
		66602: (e, t, s) => {
			s.d(t, {
				z: () => y
			});
			...
			function y(e) {
				...
				if ((0, a.T)(t) && !confirm(s)) return !1;
				for (let e of t.querySelectorAll("input, textarea")) e.value = e.defaultValue, e.classList.contains("session-resumable-canceled") && (e.classList.add("js-session-resumable"), e.classList.remove("session-resumable-canceled"));
			...
			function h(e, t) {
				...
				n && (n.hidden = t)
			}(0, m.N7)(".js-comment-header-actions-deferred-include-fragment", {
				subscribe: e => (0, l.RB)(e, "loadstart", () => {
					let t = e.closest(".js-comment");
					g(t)
				}, {
					capture: !1,
					once: !0
				})
			}), (0, m.N7)(".js-comment .contains-task-list", {
				add: e => {
					let t = e.closest(".js-comment");
					g(t)
				}
			}), (0, n.on)("click", ".js-comment-edit-button", function(e) {
			...
			}), (0, n.on)("click", ".js-comment-hide-button", function(e) {
				let t = e.currentTarget.closest(".js-comment");
				h(t, !1);
				...
				let n = e.currentTarget.closest(".js-dropdown-details");
				n && n.removeAttribute("open")
			}), (0, n.on)("click", ".js-comment-hide-minimize-form", function(e) {
				let t = e.currentTarget.closest(".js-minimize-comment");
				t.classList.add("d-none")
			}), (0, n.on)("click", ".js-comment-cancel-button", y), (0, n.on)("click", ".js-cancel-issue-edit", function(e) {
				let t = e.currentTarget.closest(".js-details-container");
				t.querySelector(".js-comment-form-error").hidden = !0
			}), (0, c.AC)(".js-comment-delete, .js-comment .js-comment-update, .js-issue-update, .js-comment-minimize, .js-comment-unminimize", function(e, t, s) {
			...
			}), (0, c.AC)(".js-comment .js-comment-update", async function(e, t) {
				let s;
				let n = e.closest(".js-comment"),
					o = n.querySelector(".js-comment-update-error"),
					l = n.querySelector(".js-comment-body-error");
				o instanceof HTMLElement && (o.hidden = !0), l instanceof HTMLElement && (l.hidden = !0), d = [], e.classList.add("is-dirty");
				try {
					s = await t.json()
				} catch (e) {
					if (422 === e.response.status) {
						...
						if (t.errors) {
							o instanceof HTMLElement && (o.textContent = `There was an error posting your comment: ${t.errors.join(", ")}`, o.hidden = !1);
							return
						}
					} else throw e
				} finally {
				...
				if (!s) return;
				let m = s.json;
				m.errors && m.errors.length > 0 && (d = m.errors, p(l));
				let c = n.querySelector(".js-comment-body"),
					u = null != c && "async" === e.getAttribute("data-submitting-tracking-block-update") && (0, a.M)(c, !0, !0);
				if (c && m.body && !u && (0, i.jI)(c, m.body, {
						keepInputValues: !0
					}), null != m.source) {
					let e = n.querySelector(".js-comment-field");
					if (e && (e.defaultValue = m.source, u || (e.value = m.source)), m.default_merge_commit_message) {
					...
					document.querySelector(".js-merge-box-button-merge")?.setAttribute("data-input-message-value", m.default_merge_commit_message), document.querySelector(".js-merge-box-button-squash")?.setAttribute("data-input-message-value", m.default_squash_commit_message)
				}
				...
				for (let e of (j && m.poll && (j.innerHTML = m.poll), n.querySelectorAll("input, textarea"))) e.defaultValue = e.value;
				n.classList.remove("is-comment-stale"), e.hasAttribute("data-submitting-tracking-block-update") || n.classList.remove("is-comment-editing");
				let g = n.querySelector(".js-comment-edit-history");
				if (g) {
					let e = await (0, r.a_)(document, m.editUrl);
					(0, i.nn)(g, e)
				}
			}), (0, m.N7)(".js-comment-body-error", {
				add: e => {
					d && d.length > 0 && p(e)
				}
			}), (0, c.AC)(".js-comment .js-comment-delete, .js-comment .js-comment-update, .js-comment-minimize, .js-comment-unminimize", async function(e, t) {
				let s;
				let n = e.closest(".js-comment");
				try {
					await t.text()
			...
			}), (0, c.AC)(".js-timeline-comment-unminimize, .js-timeline-comment-minimize", async function(e, t) {
			...
			}), (0, c.AC)(".js-discussion-comment-unminimize, .js-discussion-comment-minimize", async function(e, t) {
				...
				try {
					...
					if (e.response.status >= 400 && e.response.status < 500) {
						if (e.response.html) {
							...
							n instanceof HTMLElement && (n.textContent = t, n.hidden = !1)
						}
					} else throw e
				}
			}), (0, c.AC)(".js-comment-delete", async function(e, t) {
				await t.json();
				let s = e.closest(".js-comment-delete-container");
				!s && (s = e.closest(".js-comment-container") || e.closest(".js-line-comments")) && 1 !== s.querySelectorAll(".js-comment").length && (s = e.closest(".js-comment"));
				let n = s?.closest(".js-comment-container") || s?.closest(".js-line-comments");
				if (s?.remove(), n && 1 === n.querySelectorAll(".js-comment").length)
					for (let e of n.querySelectorAll(".js-delete-on-last-reply-deleted")) e.remove()
			}), (0, c.AC)(".js-issue-update", async function(e, t) {
				let s;
				...
				try {
					...
					i.textContent = e.response?.json?.errors?.[0] || "Something went wrong. Please try again.", i.hidden = !1
				}
				if (!s) return;
				n.classList.remove("open"), i.hidden = !0;
				let o = s.json;
				...
				for (let t of (document.title = o.page_title, e.elements))(t instanceof HTMLInputElement || t instanceof HTMLTextAreaElement) && (t.defaultValue = t.value)
			}), (0, c.AC)(".js-comment-minimize", async function(e, t) {
				await t.json();
				...
				if (n && n.classList.contains("js-update-minimized-content")) {
					...
					i && i.classList.remove("d-none"), i && i.classList.add("js-comment")
				}
			}), (0, c.AC)(".js-comment-unminimize", async function(e, t) {
				await t.json();
				let s = e.closest(".js-minimizable-comment-group"),
				...
				if (n) n.classList.remove("d-none"), n.classList.add("js-comment"), i && i.classList.add("d-none"), i && i.classList.remove("js-comment");
					...
					if (i) {
						...
						e && e.classList.add("d-none"), i.classList.remove("js-comment")
					}
					let e = s.closest(".js-comment-container");
					await (0, u.x0)(e)
				}
			}), (0, n.on)("details-menu-select", ".js-comment-edit-history-menu", e => {
				let t = e.detail.relatedTarget.getAttribute("data-edit-history-url");
				if (!t) return;
				e.preventDefault();
				let s = (0, r.a_)(document, t);
				(0, o.W)({
					content: s,
		...
		81775: (e, t, s) => {
			...
			function r(e) {
				...
				let t = e.currentTarget;
				"" === t.value.trim() ? t.setCustomValidity(t.getAttribute("data-required-trimmed")) : t.setCustomValidity(""), a(t.form)
				...
				function s() {
					...
					s !== t && e.form && a(e.form), t = s
				}
				e.addEventListener("input", s), e.addEventListener("blur", function t() {
					e.removeEventListener("input", s), e.removeEventListener("blur", t)
				})
			});
			let l = new WeakMap;
			...
			function a(e) {
				let t = e.checkValidity();
				for (let s of e.querySelectorAll("button[data-disable-invalid]")) s.disabled = !t
			}(0, i.N7)("button[data-disable-invalid]", {
				constructor: HTMLButtonElement,
				initialize(e) {
					let t = e.form;
					t && (l.get(t) || (t.addEventListener("change", () => a(t)), l.set(t, !0)), e.disabled = !t.checkValidity())
				}
			}), (0, i.N7)("input[data-required-change], textarea[data-required-change]", function(e) {
				let t = "radio" === e.type && e.form ? e.form.elements.namedItem(e.name).value : null;

				function s(s) {
					let n = e.form;
					if (s && "radio" === e.type && n && t)
						for (let s of n.elements.namedItem(e.name)) s instanceof HTMLInputElement && s.setCustomValidity(e.value === t ? "unchanged" : "");
					else e.setCustomValidity(e.value === (t || e.defaultValue) ? "unchanged" : "")
				}
				e.addEventListener("input", s), e.addEventListener("change", s), s(), e.form && a(e.form)
...
//# sourceMappingURL=app_assets_modules_github_behaviors_commenting_edit_ts-app_assets_modules_github_behaviors_ht-83c235-e87c0f49bc9d.js.map