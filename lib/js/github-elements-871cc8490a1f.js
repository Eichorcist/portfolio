...
(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
	["github-elements"], {
		10361: (e, t, i) => {
			i(51503), i(38257), i(14840), i(57260), i(13002), i(73921);
			var n, r = i(27034);
			...
			function a(e, t, i, n) {
				...
				if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(e, t, i, n);
					...
					for (var o = e.length - 1; o >= 0; o--)(r = e[o]) && (a = (s < 3 ? r(a) : s > 3 ? r(t, i, a) : r(t, i)) || a);
			...
			a([s.fA], o.prototype, "helpField", void 0), a([s.GO], o.prototype, "helpTexts", void 0), a([s.GO], o.prototype, "cloneURLButtons", void 0), o = a([s.Ih], o);
			var h = new WeakMap,
				m = new WeakMap,
				p = new WeakMap,
				f = new WeakMap;
			let g = class MarkedTextElement extends HTMLElement {
				...
				connectedCallback() {
					this.handleEvent(), this.ownerInput?.addEventListener("input", this), c(this, p, new MutationObserver(() => this.handleEvent()))
				}
				handleEvent() {
					u(this, f) && cancelAnimationFrame(u(this, f)), c(this, f, requestAnimationFrame(() => this.mark()))
				}
				disconnectedCallback() {
					this.ownerInput?.removeEventListener("input", this), u(this, p).disconnect()
				}
				mark() {
					let e = this.textContent || "",
						t = this.query;
					if (e === u(this, h) && t === u(this, m)) return;
					c(this, h, e), c(this, m, t), u(this, p).disconnect();
					let i = 0,
						n = document.createDocumentFragment();
					for (let r of (this.positions || function(e, t) {
							let i = [],
								n = 0;
						...
						if (Number(r) !== r || r < i || r > e.length) continue;
						let t = e.slice(i, r);
						"" !== t && n.appendChild(document.createTextNode(e.slice(i, r))), i = r + 1;
						let s = document.createElement("mark");
						s.textContent = e[r], n.appendChild(s)
					}
					n.appendChild(document.createTextNode(e.slice(i))), this.replaceChildren(n), u(this, p).observe(this, {
						attributes: !0,
						childList: !0,
						subtree: !0
					})
			...
			function w(e) {
				...
				(function(e, t) {
					let i = e.querySelector("[data-more-than-n-chars]"),
						...
						r = e.querySelector("[data-number-requirement]"),
					...
					for (let e of [i, n, r, s]) e?.classList.remove(...a, ...o);
					if (t.hasMinimumPassphraseLength && i) i.classList.add(...o);
					else if (t.valid) n.classList.add(...o), r.classList.add(...o), s.classList.add(...o);
					else {
						let e = t.hasMinimumCharacterCount ? o : a,
							l = t.hasNumber ? o : a,
							u = t.hasLowerCase ? o : a;
						i?.classList.add(...a), n.classList.add(...e), r.classList.add(...l), s.classList.add(...u)
					}
				})(t, r), (0, v.G)(n)
			}
			...
			let E = class PollIncludeFragmentElement extends r.Z {
				async fetch(e, t = 1e3) {
			...
			y([s.fA], E.prototype, "retryButton", void 0), E = y([s.Ih], E);
			var x = i(10160);
			let C = e => void 0 === e || /\n/.test(e),
				L = ["position:absolute;", "overflow:auto;", "word-wrap:break-word;", "top:0px;", "left:-9999px;"],
				_ = ["box-sizing", "font-family", "font-size", "font-style", "font-variant", "font-weight", "height", "letter-spacing", "line-height", "max-height", "min-height", "padding-bottom", "padding-left", "padding-right", "padding-top", "border-bottom", "border-left", "border-right", "border-top", "text-decoration", "text-indent", "text-transform", "width", "word-spacing"],
				T = new WeakMap,
				k = new WeakMap,
				S = class SlashCommandExpander {
					destroy() {
					...
					setMenu(e, t) {
						...
						let {
							...
							let {
								...
								if ("textarea" !== r && "input" !== r) throw Error("expected textField to a textarea or input");
								let s = T.get(e);
								if (s && s.parentElement === e.parentElement) s.textContent = "";
								else {
									s = document.createElement("div"), T.set(e, s);
									let t = window.getComputedStyle(e),
										i = L.slice(0);
									"textarea" === r ? i.push("white-space:pre-wrap;") : i.push("white-space:nowrap;");
									for (let e = 0, n = _.length; e < n; e++) {
										let n = _[e];
										i.push(`${n}:${t.getPropertyValue(n)};`)
									}
									s.style.cssText = i.join(" ")
								}
								let a = document.createElement("span");
								if (a.style.cssText = "position: absolute;", a.textContent = "\xa0", "number" == typeof t) {
									let r = e.value.substring(0, t);
									r && (i = document.createTextNode(r)), (r = e.value.substring(t)) && (n = document.createTextNode(r))
								} else {
									let t = e.value;
									t && (i = document.createTextNode(t))
								}
								if (i && s.appendChild(i), s.appendChild(a), n && s.appendChild(n), !s.parentElement) {
							...
							}(e, t), r = i.getBoundingClientRect(), s = n.getBoundingClientRect();
							return setTimeout(() => {
								i.remove()
							}, 5e3), {
								top: s.top - r.top,
						...
						}(this.input, e.position), s = parseInt(window.getComputedStyle(this.input).fontSize);
						t.style.top = `${n+s}px`, t.style.left = `${r}px`, this.combobox.start(), t.addEventListener("combobox-commit", this.oncommit), t.addEventListener("mousedown", this.onmousedown), this.combobox.navigate(1)
					}
					setValue(e) {
						if (null == e) return;
						let t = this.match;
						...
						n = n?.length === 0 ? n : `${n} `;
						let r = t.position - t.key.length,
							s = t.position + t.text.length;
						this.input.focus();
						let a = !1;
						try {
							this.input.setSelectionRange(r, s), a = document.execCommand("insertText", !1, n)
						} catch (e) {
							a = !1
						}
						if (!a) {
						...
						this.deactivate(), i = r + (i || n.length), this.input.selectionStart = i, this.input.selectionEnd = i
					}
					replaceCursorMark(e) {
						let t = /%cursor%/gm,
							i = t.exec(e);
					...
					async notifyProviders(e) {
						let t = [],
							n = e => t.push(e),
							r = new CustomEvent("text-expander-change", {
								cancelable: !0,
								detail: {
									provide: n,
									text: e.text,
			...
			let A = class TextSuggesterElement extends HTMLElement {
				acceptSuggestion() {
			...
			M([s.fA], A.prototype, "input", void 0), M([s.fA], A.prototype, "suggestionContainer", void 0), M([s.fA], A.prototype, "suggestion", void 0), A = M([s.Ih], A);
			var R = new WeakMap,
				j = new WeakMap,
				N = new WeakMap,
				z = new WeakMap,
				H = new WeakMap,
				F = new WeakMap;
			let B = class VirtualFilterInputElement extends HTMLElement {
				...
				get filtered() {
					...
					if (this.hasAttribute("aria-owns")) {
						...
						e && (e instanceof Set || e && "object" == typeof e && "size" in e && "add" in e && "delete" in e && "clear" in e) && O(this, F, e)
					}
					return O(this, F, I(this, F) || new Set)
				}
				set filtered(e) {
					O(this, F, e)
				}
				...
				attributeChangedCallback(e, t, i) {
					let n = this.isConnected && this.src,
						r = "eager" === this.loading,
						s = t !== i;
					("src" === e || "data-property" === e) && s && (O(this, N, null), I(this, z) && clearTimeout(I(this, z))), n && r && ("src" === e || "loading" === e || "accept" === e || "data-property" === e) && s ? (cancelAnimationFrame(I(this, j)), O(this, j, requestAnimationFrame(() => this.load()))) : "aria-owns" === e && O(this, F, null)
				}
				connectedCallback() {
				...
				handleEvent(e) {
					"input" === e.type && (I(this, z) && clearTimeout(I(this, z)), O(this, z, window.setTimeout(() => this.filterItems(), (this.input?.value?.length, 300))))
				}
				async load() {
					...
					if (await new Promise(e => setTimeout(e, 0)), !e.aborted) {
						...
						try {
							...
							O(this, H, new Set((await t.json())[this.property])), O(this, N, null), this.dispatchEvent(new Event("loadend"))
						} catch (t) {
							if (e.aborted) {
				...
				constructor(...e) {
					super(...e), P(this, R, {
						...
						writable: !0,
						value: void 0
					}), O(this, j, 0), O(this, N, null), O(this, H, new Set), O(this, F, null), this.filter = (e, t) => String(e).includes(t)
				}
			};
			...
			window.customElements.get("virtual-filter-input") || (window.VirtualFilterInputElement = B, window.customElements.define("virtual-filter-input", B));
				...
				et = class VirtualListElement extends HTMLElement {
					...
					get range() {
						let e = this.getBoundingClientRect().height,
							...
							i = `${t}-${e}`;
						if (D(this, J).has(i)) return D(this, J).get(i);
						let n = 0,
							r = 0,
							s = 0,
							a = 0,
							o = D(this, Z);
						for (let i of D(this, Y)) {
							let l = o.get(i) || D(this, K);
							if (s + l < t) s += l, n += 1, r += 1;
							else if (a - l < e) a += l, r += 1;
							else if (a >= e) break
						}
						return [n, r]
					}
					...
					attributeChangedCallback(e, t, i) {
						...
						let n = "data-updating" === e && "eager" === i,
							r = "data-sorted" === e && this.hasAttribute("data-sorted");
						if ((n || r) && this.update(), "aria-activedescendant" === e) {
					...
					update() {
						D(this, Q) && cancelAnimationFrame(D(this, Q)), !D(this, G) && this.hasAttribute("data-sorted") ? $(this, Q, requestAnimationFrame(() => {
					...
					recalculateHeights(e) {
						...
						t.replaceChildren(), n && ($(this, K, n), D(this, Z).set(e, n))
					}
					getIndexByElementId(e) {
						if (!e) return -1;
						let t = 0;
						for (let [, i] of D(this, X)) {
					...
					updateSync() {
						...
						let r = new Map,
							...
							u = 0,
							d = 0;
						for (let e of D(this, Y)) {
							if (-1 !== a || Number.isFinite(D(this, K)) && 0 !== D(this, K) || this.recalculateHeights(e), a += 1, d = D(this, Z).get(e) || D(this, K), a < t) {
								l += d, u = l;
								continue
							}
							if (a > i) {
							...
							let n = null;
							if (s.has(e)) n = s.get(e);
							else {
								if (!(n = this.renderItem(e))) continue;
								n.querySelector("[aria-setsize]")?.setAttribute("aria-setsize", D(this, Y).size.toString()), n.querySelector("[aria-posinset]")?.setAttribute("aria-posinset", (a + 1).toString()), s.set(e, n)
							}
							n.querySelector("[tabindex]")?.setAttribute("data-scrolltop", u.toString()), u += d, r.set(e, n)
						}
						e.replaceChildren(...r.values()), e.style.paddingTop = `${l}px`;
						...
						for (let [e, t] of r) {
							...
							h = h || n >= m, D(this, Z).set(e, i)
						}
						let p = !o && this.size > r.size;
						if (p && !h) return D(this, J).delete(`${this.scrollTop}-${this.getBoundingClientRect().height}`), this.update();
						this.dispatchEvent(new RenderedEvent(s)), this.dispatchEvent(new CustomEvent("virtual-list-updated"))
					}
					resetRenderCache() {
						$(this, X, new Map)
					}
					has(e) {
						return D(this, Y).has(e)
					}
					add(e) {
						return D(this, Y).add(e), $(this, G, !1), Number.isFinite(D(this, K)) || this.recalculateHeights(e), this.resetRenderCache(), this.dispatchEvent(new Event("virtual-list-data-updated")), "eager" === this.updating && this.update(), this
					}
					delete(e) {
						let t = D(this, Y).delete(e);
						return $(this, G, !1), D(this, Z).delete(e), this.resetRenderCache(), this.dispatchEvent(new Event("virtual-list-data-updated")), "eager" === this.updating && this.update(), t
					}
					clear() {
						D(this, Y).clear(), D(this, Z).clear(), $(this, K, 1 / 0), $(this, G, !0), this.resetRenderCache(), this.dispatchEvent(new Event("virtual-list-data-updated")), "eager" === this.updating && this.update()
					}
					forEach(e, t) {
						for (let i of this) e.call(t, i, i, this)
					}
					entries() {
						return D(this, Y).entries()
					}
					values() {
						return D(this, Y).values()
					}
					keys() {
						return D(this, Y).keys()
					} [ee]() {
						return D(this, Y)[Symbol.iterator]()
					}
					sort(e) {
						return $(this, Y, new Set(Array.from(this).sort(e))), $(this, G, !0), this.dispatchEvent(new Event("virtual-list-data-updated")), "eager" === this.updating && this.update(), this
					}
					constructor(...e) {
						super(...e), V(this, G, {
							writable: !0,
							...
							writable: !0,
							value: void 0
						}), $(this, G, !1), $(this, Y, new Set), $(this, Z, new Map), $(this, K, 1 / 0), $(this, J, new Map), $(this, X, new Map), $(this, Q, 0)
					}
				};
			...
			ei([s.fA], en.prototype, "input", void 0), ei([s.fA], en.prototype, "showButton", void 0), ei([s.fA], en.prototype, "hideButton", void 0), en = ei([s.Ih], en);
			var er = i(22490),
				es = i(7180);
			let ea = "include-fragment-element-no-op",
				eo = er.ZO.createPolicy(ea, {
					createHTML: e => es.O.apply({
						policy: () => e,
						policyName: ea,
						fallback: e,
						fallbackOnError: !0
		...
		81775: (e, t, i) => {
			...
			function a(e) {
				...
				let t = e.currentTarget;
				a(t)
			}), (0, s.on)("change", "[data-required-value]", function(e) {
				let t = e.currentTarget;
				a(t), l(t.form)
			...
			}), (0, s.on)("change", "[data-required-trimmed]", function(e) {
				let t = e.currentTarget;
		...
		97895: (e, t, i) => {
			...
			let r = (e, t, i) => {
				...
				s = (e, t, i) => {
					e.textContent = "";
					let r = 0;
					for (let s of (0, n.m7)(t, i)) {
						let t = i.slice(r, s);
						"" !== t && e.appendChild(document.createTextNode(i.slice(r, s))), r = s + 1;
						let n = document.createElement("mark");
						n.textContent = i[s], e.appendChild(n)
					}
					e.appendChild(document.createTextNode(i.slice(r)))
				},
				a = new WeakMap,
				o = new WeakMap,
				l = new WeakMap,
				...
				d = class FuzzyListElement extends HTMLElement {
					connectedCallback() {
						...
						let r = new MutationObserver(e => {
							let i = !1;
							for (let r of e)
								if ("childList" === r.type && r.addedNodes.length) {
									for (let e of r.addedNodes)
										if (e instanceof HTMLLIElement && !t.has(e)) {
											let r = u(e);
											i = i || (0, n.CD)(this.value, r), t.add(e)
										}
								} i && this.sort()
						});
						r.observe(e, {
					...
					addLazyItems(e, t) {
						...
						for (let i of e) r.set(i, t), a = a || !!s && (0, n.CD)(s, i);
						a && this.sort()
					}
					sort() {
						let e = a.get(this);
								...
								r = () => {
									...
									for (let e = i; e < a; e += 1) {
										...
										if ("render" in t && "text" in t) {
											...
											i = e(n), m.add(i), l.set(i, n), p.delete(n)
										} else "item" in t && (i = t.item);
										i instanceof HTMLElement && (f && s(n && i.querySelector(n) || i, f ? c : "", u(i)), o.appendChild(i))
									}
									i = a;
									let d = !1;
									...
									if (g.appendChild(o), e && d && e.dispatchEvent(new Event("change", {
											bubbles: !0
										})), a < v.length) requestAnimationFrame(r);
									else {
										g.hidden = 0 === v.length;
		...
		254: (e, t, i) => {
			...
			function a(e) {
				...
				if (t instanceof HTMLElement && t.nodeType !== Node.DOCUMENT_NODE)
					for (let e of s.matches(t)) e.data.call(null, t)
			}

			function o(e, t) {
				r || (r = !0, document.addEventListener("focus", a, !0)), s.add(e, t), document.activeElement instanceof HTMLElement && document.activeElement.matches(e) && t(document.activeElement)
			}
		...
		89359: (e, t, i) => {
			...
			function r() {
				return `${window.location.protocol}//${window.location.host}${function(){let e=n("meta[name=analytics-location]");return e?e.content:window.location.pathname}()+function(){let e=n("meta[name=analytics-location-query-strip]"),t="";e||(t=window.location.search);let i=n("meta[name=analytics-location-params]");for(let e of(i&&(t+=(t?"&":"?")+i.content),document.querySelectorAll("meta[name=analytics-param-rename]"))){let i=e.content.split(":",2);t=t.replace(RegExp(`( ^ | [ ? & ]) $ {
					i[0]
				}($ |= )`,"g"),`
				$1$ {
					i[1]
		...
		24601: (e, t, i) => {
			...
			let c = !1,
				h = 0,
				m = Date.now(),
				p = new Set(["Failed to fetch", "NetworkError when attempting to fetch resource."]);

			function f(e) {
				return !!("AbortError" === e.name || "TypeError" === e.name && p.has(e.message) || e.name.startsWith("ApiError") && p.has(e.message))
			}

			function g(e, t = {}) {
				if ((0, d.c)("FAILBOT_HANDLE_NON_ERRORS")) {
			...
			let C = !1;
			if (u.iG?.addEventListener("pageshow", () => C = !1), u.iG?.addEventListener("pagehide", () => C = !0), "function" == typeof BroadcastChannel) {
			...
			let u = {
				apply: function({
					...
					try {
						...
						if (e instanceof TrustedTypesPolicyError || (d || (0, s.eK)(e), (0, r.b)({
